...
func (x *QrcodeRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *QrcodeRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *QrcodeRequest) GetTop() int32 {
	if x != nil {
		return x.Top
	}
	return 0
...
func (x *QrcodeData) GetEntity() *Qrcode {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *QrcodeData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *QrcodeData) GetItems() []*Qrcode {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *QrcodeData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
type QrcodeResponse struct {
	...
	Data  *QrcodeData   `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *QrcodeResponse) Reset() {
	*x = QrcodeResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_qrcodeService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QrcodeResponse) Descriptor() ([]byte, []int) {
	return file_qrcodeService_proto_rawDescGZIP(), []int{3}
}

func (x *QrcodeResponse) GetData() *QrcodeData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_qrcodeService_proto_rawDesc = []byte{
	...
	0x1a, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xa5, 0x01, 0x0a, 0x0a, 0x51,
	0x72, 0x63, 0x6f, 0x64, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x28, 0x0a, 0x06, 0x65, 0x6e, 0x74,
	0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x06, 0x65, 0x6e, 0x74,
	...
	0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	...
	0x66, 0x6f, 0x22, 0x5f, 0x0a, 0x0e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70,
	0x6f, 0x6e, 0x73, 0x65, 0x12, 0x28, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72,
	0x63, 0x6f, 0x64, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x23,
	...
	0x72, 0x6f, 0x72, 0x32, 0xf6, 0x02, 0x0a, 0x0d, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12,
	0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64,
	0x65, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63,
	0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x36, 0x0a,
	0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
	0x12, 0x3b, 0x0a, 0x04, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63,
	...
	0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74,
	0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x51, 0x72, 0x63, 0x6f,
...
var file_qrcodeService_proto_goTypes = []interface{}{
	...
	(*QrcodeData)(nil),     // 2: services.QrcodeData
	(*QrcodeResponse)(nil), // 3: services.QrcodeResponse
	(*common.Pager)(nil),   // 4: common.Pager
	(*common.Info)(nil),    // 5: common.Info
	(*common.Error)(nil),   // 6: common.Error
}
var file_qrcodeService_proto_depIdxs = []int32{
	0,  // 0: services.QrcodeData.entity:type_name -> services.Qrcode
	4,  // 1: services.QrcodeData.pager:type_name -> common.Pager
	0,  // 2: services.QrcodeData.items:type_name -> services.Qrcode
	5,  // 3: services.QrcodeData.info:type_name -> common.Info
	2,  // 4: services.QrcodeResponse.data:type_name -> services.QrcodeData
	6,  // 5: services.QrcodeResponse.error:type_name -> common.Error
	0,  // 6: services.QrcodeService.Create:input_type -> services.Qrcode
	0,  // 7: services.QrcodeService.Update:input_type -> services.Qrcode
	1,  // 8: services.QrcodeService.Delete:input_type -> services.QrcodeRequest
	1,  // 9: services.QrcodeService.Get:input_type -> services.QrcodeRequest
	1,  // 10: services.QrcodeService.List:input_type -> services.QrcodeRequest
	1,  // 11: services.QrcodeService.Search:input_type -> services.QrcodeRequest
	3,  // 12: services.QrcodeService.Create:output_type -> services.QrcodeResponse
	3,  // 13: services.QrcodeService.Update:output_type -> services.QrcodeResponse
	3,  // 14: services.QrcodeService.Delete:output_type -> services.QrcodeResponse
	3,  // 15: services.QrcodeService.Get:output_type -> services.QrcodeResponse
	3,  // 16: services.QrcodeService.List:output_type -> services.QrcodeResponse
	3,  // 17: services.QrcodeService.Search:output_type -> services.QrcodeResponse
...
func file_qrcodeService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_qrcodeService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
