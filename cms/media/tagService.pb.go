...
func (x *TatRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *TatRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *TatRequest) GetTop() int32 {
	if x != nil {
		return x.Top
	}
	return 0
...
var file_tagService_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x9c, 0x01, 0x0a, 0x07, 0x54, 0x61, 0x67, 0x44, 0x61, 0x74,
	...
	0xd8, 0x01, 0x0a, 0x0a, 0x54, 0x61, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x30,
	...
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x54, 0x61, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x54, 0x61, 0x67,
...
var file_tagService_proto_depIdxs = []int32{
	...
	1,  // 9: services.TagService.Search:input_type -> services.TatRequest
	3,  // 10: services.TagService.Create:output_type -> services.TagResponse
	3,  // 11: services.TagService.Delete:output_type -> services.TagResponse
	3,  // 12: services.TagService.Get:output_type -> services.TagResponse
	3,  // 13: services.TagService.Search:output_type -> services.TagResponse
