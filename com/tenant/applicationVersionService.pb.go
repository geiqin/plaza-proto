...
type ApplicationVersion struct {
	...
	Code          string         `protobuf:"bytes,2,opt,name=code,proto3" json:"code,omitempty"`                                         //版本编码
	Name          string         `protobuf:"bytes,3,opt,name=name,proto3" json:"name,omitempty"`                                         //版本名称
	ApplicationId int32          `protobuf:"varint,4,opt,name=application_id,json=applicationId,proto3" json:"application_id,omitempty"` //所属应用
	...
	IsDefault     string         `protobuf:"bytes,8,opt,name=is_default,json=isDefault,proto3" json:"is_default,omitempty"`              //是否默认
	Config        *VersionConfig `protobuf:"bytes,9,opt,name=config,proto3" json:"config,omitempty"`                                     //使用配置
	Status        string         `protobuf:"bytes,10,opt,name=status,proto3" json:"status,omitempty"`                                    //状态
	CreatedAt     int64          `protobuf:"varint,11,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`            //
	UpdatedAt     int64          `protobuf:"varint,12,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`            //
	Application   *Application   `protobuf:"bytes,13,opt,name=application,proto3" json:"application,omitempty"`
}
...
type VersionConfig struct {
	...
	ShopLimitCount      int32   `protobuf:"varint,1,opt,name=shop_limit_count,json=shopLimitCount,proto3" json:"shop_limit_count,omitempty"`                   //商户限制数量
	RealstoreLimitCount int32   `protobuf:"varint,2,opt,name=realstore_limit_count,json=realstoreLimitCount,proto3" json:"realstore_limit_count,omitempty"`    //门店限制数量
	WarehouseLimitCount int32   `protobuf:"varint,3,opt,name=warehouse_limit_count,json=warehouseLimitCount,proto3" json:"warehouse_limit_count,omitempty"`    //仓库限制数量
	ManagerLimitCount   int32   `protobuf:"varint,4,opt,name=manager_limit_count,json=managerLimitCount,proto3" json:"manager_limit_count,omitempty"`          //管理员限制数量
	MemberLimitCount    int32   `protobuf:"varint,5,opt,name=member_limit_count,json=memberLimitCount,proto3" json:"member_limit_count,omitempty"`             //会员限制数量
	SpuLimitCount       int32   `protobuf:"varint,6,opt,name=spu_limit_count,json=spuLimitCount,proto3" json:"spu_limit_count,omitempty"`                      //商品限制数量
	OrderFreeType       string  `protobuf:"bytes,7,opt,name=order_free_type,json=orderFreeType,proto3" json:"order_free_type,omitempty"`                       //订单成交免费类型
	OrderFreeTotalLimit int32   `protobuf:"varint,8,opt,name=order_free_total_limit,json=orderFreeTotalLimit,proto3" json:"order_free_total_limit,omitempty"`  //订单成交免费总限制
	OrderFreeYearLimit  int32   `protobuf:"varint,9,opt,name=order_free_year_limit,json=orderFreeYearLimit,proto3" json:"order_free_year_limit,omitempty"`     //订单成交免费年度限制
	OrderFreeMonthLimit int32   `protobuf:"varint,10,opt,name=order_free_month_limit,json=orderFreeMonthLimit,proto3" json:"order_free_month_limit,omitempty"` //订单成交免费月度限制
	OrderCommissionRate float32 `protobuf:"fixed32,11,opt,name=order_commission_rate,json=orderCommissionRate,proto3" json:"order_commission_rate,omitempty"`  //订单成交抽成比例
	MediaLimitCount     int32   `protobuf:"varint,12,opt,name=media_limit_count,json=mediaLimitCount,proto3" json:"media_limit_count,omitempty"`               //媒体限制数量
	MediaLimitVolume    int32   `protobuf:"varint,13,opt,name=media_limit_volume,json=mediaLimitVolume,proto3" json:"media_limit_volume,omitempty"`            //媒体限制容量
	ArticleLimitCount   int32   `protobuf:"varint,14,opt,name=article_limit_count,json=articleLimitCount,proto3" json:"article_limit_count,omitempty"`         //文章限制数量
}
...
type ApplicationVersionRequest struct {
	...
	// 以下为自定义参数
	Code          string `protobuf:"bytes,11,opt,name=code,proto3" json:"code,omitempty"`                                         //版本编码
	Name          string `protobuf:"bytes,12,opt,name=name,proto3" json:"name,omitempty"`                                         //版本名称
	ApplicationId int32  `protobuf:"varint,13,opt,name=application_id,json=applicationId,proto3" json:"application_id,omitempty"` //所属应用
...
type ApplicationVersionResponse struct {
	...
	Entity *ApplicationVersion   `protobuf:"bytes,1,opt,name=entity,proto3" json:"entity,omitempty"`
	Pager  *common.Pager         `protobuf:"bytes,2,opt,name=pager,proto3" json:"pager,omitempty"`
	Items  []*ApplicationVersion `protobuf:"bytes,3,rep,name=items,proto3" json:"items,omitempty"`
