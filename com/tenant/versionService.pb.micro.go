...
func (c *versionService) List(ctx context.Context, in *VersionRequest, opts ...client.CallOption) (*VersionResponse, error) {
	req := c.c.NewRequest(c.name, "VersionService.List", in)
	out := new(VersionResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (h *versionServiceHandler) List(ctx context.Context, in *VersionRequest, out *VersionResponse) error {
	return h.VersionServiceHandler.List(ctx, in, out)
}
