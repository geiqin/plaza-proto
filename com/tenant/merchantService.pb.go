...
type Merchant struct {
	...
	CreatedAt         int64  `protobuf:"varint,26,opt,name=created_at,json=createdAt,proto3" json:"created_at"`                       //
	UpdatedAt         int64  `protobuf:"varint,27,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at"`                       //
}
...
var file_merchantService_proto_rawDesc = []byte{
	...
	0x61, 0x74, 0x18, 0x1a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65,
