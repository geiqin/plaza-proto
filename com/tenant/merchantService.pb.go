...
type Merchant struct {
	...
	RegisteredDate    int64  `protobuf:"varint,10,opt,name=registered_date,json=registeredDate,proto3" json:"registered_date"`        //成立日期
	...
	DistrictId        int64  `protobuf:"varint,13,opt,name=district_id,json=districtId,proto3" json:"district_id"`                    //所属区
	...
	Website           string `protobuf:"bytes,19,opt,name=website,proto3" json:"website"`                                             //公司官网
	Memo              string `protobuf:"bytes,20,opt,name=memo,proto3" json:"memo"`                                                   //备注
	InvoiceType       string `protobuf:"bytes,21,opt,name=invoice_type,json=invoiceType,proto3" json:"invoice_type"`                  //发票类型
	Property          string `protobuf:"bytes,22,opt,name=property,proto3" json:"property"`                                           //单位性质
	IsTrusted         string `protobuf:"bytes,23,opt,name=is_trusted,json=isTrusted,proto3" json:"is_trusted"`                        //是否实名
	StoreCount        int32  `protobuf:"varint,24,opt,name=store_count,json=storeCount,proto3" json:"store_count"`                    //店铺数量
	CreatorId         int64  `protobuf:"varint,28,opt,name=creator_id,json=creatorId,proto3" json:"creator_id"`                       //创建者
	Status            string `protobuf:"bytes,29,opt,name=status,proto3" json:"status"`                                               //状态
	CreatedAt         int64  `protobuf:"varint,30,opt,name=created_at,json=createdAt,proto3" json:"created_at"`                       //
	UpdatedAt         int64  `protobuf:"varint,31,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at"`                       //
	ProvinceName      string `protobuf:"bytes,32,opt,name=province_name,json=provinceName,proto3" json:"province_name"`               //所属省名
	CityName          string `protobuf:"bytes,33,opt,name=city_name,json=cityName,proto3" json:"city_name"`                           //所属市名
	DistrictName      string `protobuf:"bytes,34,opt,name=district_name,json=districtName,proto3" json:"district_name"`               //所属区名
}
...
type MerchantRequest struct {
	...
	DistrictId   int64  `protobuf:"varint,19,opt,name=district_id,json=districtId,proto3" json:"district_id"`      //所属区
