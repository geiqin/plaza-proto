...
type ApplicationService interface {
	...
	Delete(ctx context.Context, in *Application, opts ...client.CallOption) (*ApplicationResponse, error)
	Get(ctx context.Context, in *Application, opts ...client.CallOption) (*ApplicationResponse, error)
	Search(ctx context.Context, in *ApplicationRequest, opts ...client.CallOption) (*ApplicationResponse, error)
	List(ctx context.Context, in *ApplicationRequest, opts ...client.CallOption) (*ApplicationResponse, error)
}
...
func (c *applicationService) Delete(ctx context.Context, in *Application, opts ...client.CallOption) (*ApplicationResponse, error) {
...
func (c *applicationService) Search(ctx context.Context, in *ApplicationRequest, opts ...client.CallOption) (*ApplicationResponse, error) {
...
func (c *applicationService) List(ctx context.Context, in *ApplicationRequest, opts ...client.CallOption) (*ApplicationResponse, error) {
...
type ApplicationServiceHandler interface {
	...
	Delete(context.Context, *Application, *ApplicationResponse) error
	Get(context.Context, *Application, *ApplicationResponse) error
	Search(context.Context, *ApplicationRequest, *ApplicationResponse) error
	List(context.Context, *ApplicationRequest, *ApplicationResponse) error
}
...
func RegisterApplicationServiceHandler(s server.Server, hdlr ApplicationServiceHandler, opts ...server.HandlerOption) error {
	type applicationService interface {
		...
		Delete(ctx context.Context, in *Application, out *ApplicationResponse) error
		Get(ctx context.Context, in *Application, out *ApplicationResponse) error
		Search(ctx context.Context, in *ApplicationRequest, out *ApplicationResponse) error
		List(ctx context.Context, in *ApplicationRequest, out *ApplicationResponse) error
	}
	type ApplicationService struct {
		applicationService
	}
...
func (h *applicationServiceHandler) Delete(ctx context.Context, in *Application, out *ApplicationResponse) error {
...
func (h *applicationServiceHandler) Search(ctx context.Context, in *ApplicationRequest, out *ApplicationResponse) error {
	return h.ApplicationServiceHandler.Search(ctx, in, out)
}

func (h *applicationServiceHandler) List(ctx context.Context, in *ApplicationRequest, out *ApplicationResponse) error {
