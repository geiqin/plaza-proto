...
type PromotionVariant struct {
	...
	Stock         string   `protobuf:"bytes,7,opt,name=stock,proto3" json:"stock,omitempty"`                                         //促销库存
...
var file_promotionVariantService_proto_rawDesc = []byte{
	...
	0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52,
