...
type PromotionVariant struct {
	...
	PromotionId   string   `protobuf:"bytes,2,opt,name=promotion_id,json=promotionId,proto3" json:"promotion_id,omitempty"`         //促销ID
	...
	SpuId         int64    `protobuf:"varint,4,opt,name=spu_id,json=spuId,proto3" json:"spu_id,omitempty"`                          //商品ID [冗余]
	SkuId         int64    `protobuf:"varint,5,opt,name=sku_id,json=skuId,proto3" json:"sku_id,omitempty"`                          //货品ID
	Stock         string   `protobuf:"bytes,6,opt,name=stock,proto3" json:"stock,omitempty"`                                        //促销库存
	Method        int64    `protobuf:"varint,7,opt,name=method,proto3" json:"method,omitempty"`                                     //优惠方式：1 折扣 2减价,3固定金额
	DiscountRate  float32  `protobuf:"fixed32,8,opt,name=discount_rate,json=discountRate,proto3" json:"discount_rate,omitempty"`    //优惠折扣
	DiscountMoney float32  `protobuf:"fixed32,9,opt,name=discount_money,json=discountMoney,proto3" json:"discount_money,omitempty"` //优惠金额(立减金额/固定金额)
	QuantityLimit int32    `protobuf:"varint,10,opt,name=quantity_limit,json=quantityLimit,proto3" json:"quantity_limit,omitempty"` //购买数量限制
	Enabled       bool     `protobuf:"varint,11,opt,name=enabled,proto3" json:"enabled,omitempty"`                                  //已启用
	...
	Sku           *SkuInfo `protobuf:"bytes,18,opt,name=sku,proto3" json:"sku,omitempty"`
}
...
func (x *PromotionVariant) GetPromotionId() string {
	if x != nil {
...
func (x *PromotionVariant) GetStock() string {
	if x != nil {
		return x.Stock
	}
	return ""
...
var file_promotionVariantService_proto_rawDesc = []byte{
	...
	0xb8, 0x03, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x72,
	...
	0x6e, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b, 0x70, 0x72, 0x6f, 0x6d,
	...
	0x0d, 0x70, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x12, 0x15,
	...
	,
	...
	0x74, 0x65, 0x64, 0x41, 0x74, 0x12, 0x23, 0x0a, 0x03, 0x73, 0x6b, 0x75, 0x18, 0x12, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6b,
	0x75, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x03, 0x73, 0x6b, 0x75, 0x42, 0x0c, 0x5a, 0x0a, 0x2e, 0x3b,
...
var file_promotionVariantService_proto_depIdxs = []int32{
	1, // 0: services.PromotionVariant.sku:type_name -> services.SkuInfo
