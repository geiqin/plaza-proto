...
type Promotion struct {
	...
	RuleConfigData     string                 `protobuf:"bytes,13,opt,name=rule_config_data,json=ruleConfigData,proto3" json:"rule_config_data,omitempty"`                       //限制规则配置json
	ActionConfigData   string                 `protobuf:"bytes,14,opt,name=action_config_data,json=actionConfigData,proto3" json:"action_config_data,omitempty"`                 //优惠策略配置json
	Status             string                 `protobuf:"bytes,15,opt,name=status,proto3" json:"status,omitempty"`                                                               //活动状态：0未开始 1进行中 2已结束 3已失效
	...
	VariantRangeSkuIds []int64                `protobuf:"varint,18,rep,packed,name=variant_range_sku_ids,json=variantRangeSkuIds,proto3" json:"variant_range_sku_ids,omitempty"` //变体商品IDS
	ActionConfig       *PromotionActionConfig `protobuf:"bytes,19,opt,name=action_config,json=actionConfig,proto3" json:"action_config,omitempty"`                               //限制规则配置
	RuleConfig         *PromotionRuleConfig   `protobuf:"bytes,20,opt,name=rule_config,json=ruleConfig,proto3" json:"rule_config,omitempty"`                                     //优惠策略配置
	Variants           *PromotionVariant      `protobuf:"bytes,21,opt,name=variants,proto3" json:"variants,omitempty"`                                                           //参与活动商品变体
}
...
func (x *Promotion) GetRuleConfigData() string {
	if x != nil {
		return x.RuleConfigData
	}
	return ""
}

func (x *Promotion) GetActionConfigData() string {
	if x != nil {
		return x.ActionConfigData
	}
	return ""
}
...
var file_promotionService_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe0, 0x05, 0x0a, 0x09, 0x50,
	...
	0x52, 0x0c, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x52, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x28,
	0x0a, 0x10, 0x72, 0x75, 0x6c, 0x65, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x72, 0x75, 0x6c, 0x65, 0x43, 0x6f,
	0x6e, 0x66, 0x69, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2c, 0x0a, 0x12, 0x61, 0x63, 0x74, 0x69,
	0x6f, 0x6e, 0x5f, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x0e,
	0x20, 0x01, 0x28, 0x09, 0x52, 0x10, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x43, 0x6f, 0x6e, 0x66,
	0x69, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73,
	...
	,
	...
	0x17, 0x0a, 0x07, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x07, 0x20, 0x01, 0x28, 0x05,
	0x52, 0x06, 0x74, 0x79, 0x70, 0x65, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x73, 0x74, 0x61, 0x72,
	...
	0x74, 0x65, 0x12, 0x10, 0x0a, 0x03, 0x69, 0x64, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28, 0x05, 0x52,
	0x03, 0x69, 0x64, 0x73, 0x22, 0xae, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69,
	0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2b, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x06, 0x65, 0x6e, 0x74,
	...
	0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x05, 0x69, 0x74,
	...
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x65, 0x0a, 0x11, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74,
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xc3, 0x03, 0x0a,
	...
	0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x05, 0x53,
	0x74, 0x61, 0x72, 0x74, 0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	...
	0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d,
	0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	...
	0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x71, 0x75,
	0x65, 0x73, 0x74, 0x1a, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50,
...
var file_promotionService_proto_depIdxs = []int32{
	...
	3,  // 16: services.PromotionService.Create:output_type -> services.PromotionResponse
	3,  // 17: services.PromotionService.Update:output_type -> services.PromotionResponse
	3,  // 18: services.PromotionService.Delete:output_type -> services.PromotionResponse
	3,  // 19: services.PromotionService.Start:output_type -> services.PromotionResponse
	3,  // 20: services.PromotionService.Stop:output_type -> services.PromotionResponse
	3,  // 21: services.PromotionService.Get:output_type -> services.PromotionResponse
	3,  // 22: services.PromotionService.List:output_type -> services.PromotionResponse
