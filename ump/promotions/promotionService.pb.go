...
type Promotion struct {
	...
	AssetUrl       string                 `protobuf:"bytes,15,opt,name=asset_url,json=assetUrl,proto3" json:"asset_url,omitempty"`                     //促销详情链接
	TotalCount     int32                  `protobuf:"varint,16,opt,name=total_count,json=totalCount,proto3" json:"total_count,omitempty"`              //发放总量 【备选项】
	AssignCount    int32                  `protobuf:"varint,17,opt,name=assign_count,json=assignCount,proto3" json:"assign_count,omitempty"`           //已发放数量 【备选项】
	UsedCount      int32                  `protobuf:"varint,18,opt,name=used_count,json=usedCount,proto3" json:"used_count,omitempty"`                 //已使用数量 【备选项】
	FailedCount    int32                  `protobuf:"varint,19,opt,name=failed_count,json=failedCount,proto3" json:"failed_count,omitempty"`           //失败，失效数量 【备选项】
	Status         string                 `protobuf:"bytes,20,opt,name=status,proto3" json:"status,omitempty"`                                         //活动状态：0未开始 1进行中 2已结束 3已失效
	CreatedAt      string                 `protobuf:"bytes,21,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"`                  //创建时间
	UpdatedAt      string                 `protobuf:"bytes,22,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at,omitempty"`                  //修改时间
	ActionConfig   *PromotionActionConfig `protobuf:"bytes,23,opt,name=action_config,json=actionConfig,proto3" json:"action_config,omitempty"`         //限制规则配置
	RuleConfig     *PromotionRuleConfig   `protobuf:"bytes,24,opt,name=rule_config,json=ruleConfig,proto3" json:"rule_config,omitempty"`               //优惠策略配置
	VariantSpuList []*PromotionVariant    `protobuf:"bytes,25,rep,name=variant_spu_list,json=variantSpuList,proto3" json:"variant_spu_list,omitempty"` //参与活动商品SPU列表
	VariantSkuList []*PromotionVariant    `protobuf:"bytes,26,rep,name=variant_sku_list,json=variantSkuList,proto3" json:"variant_sku_list,omitempty"` //参与活动商品SKU列表
}
...
var file_promotionService_proto_rawDesc = []byte{
	...
	0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x85, 0x07, 0x0a, 0x09, 0x50,
	...
	0x72, 0x55, 0x72, 0x6c, 0x12, 0x10, 0x0a, 0x03, 0x74, 0x61, 0x67, 0x18, 0x09, 0x20, 0x01, 0x28,
	...
	,
	...
	,
	...
	0x72, 0x69, 0x61, 0x6e, 0x74, 0x53, 0x70, 0x75, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x44, 0x0a, 0x10,
	0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x5f, 0x73, 0x6b, 0x75, 0x5f, 0x6c, 0x69, 0x73, 0x74,
	0x18, 0x1a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x56, 0x61, 0x72, 0x69, 0x61,
	0x6e, 0x74, 0x52, 0x0e, 0x76, 0x61, 0x72, 0x69, 0x61, 0x6e, 0x74, 0x53, 0x6b, 0x75, 0x4c, 0x69,
	0x73, 0x74, 0x22, 0x83, 0x02, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e,
	...
	0x61, 0x74, 0x75, 0x73, 0x12, 0x12, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01,
	...
	0x74, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x18, 0x0a, 0x20, 0x03, 0x28,
	0x09, 0x52, 0x05, 0x74, 0x79, 0x70, 0x65, 0x73, 0x22, 0xae, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f,
	0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2b, 0x0a, 0x06, 0x65, 0x6e,
	...
	0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x65, 0x0a, 0x11, 0x50, 0x72, 0x6f,
	0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2b,
	...
	0x32, 0x98, 0x05, 0x0a, 0x10, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x53, 0x65,
	...
	0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x13, 0x2e,
	...
	,
	...
	0x3b, 0x0a, 0x05, 0x53, 0x74, 0x61, 0x72, 0x74, 0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x1b, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69,
	0x6f, 0x6e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3a, 0x0a, 0x04,
	0x53, 0x74, 0x6f, 0x70, 0x12, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x50, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x1a, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76,
