...
type PromotionRuleConfig struct {
	...
	OrderTotalAmount      float32          `protobuf:"fixed32,1,opt,name=order_total_amount,json=orderTotalAmount,proto3" json:"order_total_amount,omitempty"`               //订单总金额
	OrderTotalCount       float32          `protobuf:"fixed32,2,opt,name=order_total_count,json=orderTotalCount,proto3" json:"order_total_count,omitempty"`                  //订单总数量
	PromotionItemsTotal   float32          `protobuf:"fixed32,3,opt,name=promotion_items_total,json=promotionItemsTotal,proto3" json:"promotion_items_total,omitempty"`      //订单中促销项目总额
	...
	IsCycleRepeat         bool             `protobuf:"varint,10,opt,name=is_cycle_repeat,json=isCycleRepeat,proto3" json:"is_cycle_repeat,omitempty"`                        //是否按周期重复
	...
	CatchLimit            int32            `protobuf:"varint,12,opt,name=catch_limit,json=catchLimit,proto3" json:"catch_limit,omitempty"`                                   //每个用户可以领取的数量
	AllowPaymentTerminals []string         `protobuf:"bytes,13,rep,name=allow_payment_terminals,json=allowPaymentTerminals,proto3" json:"allow_payment_terminals,omitempty"` //允许的支付终端
	AllowPaymentCodes     []string         `protobuf:"bytes,14,rep,name=allow_payment_codes,json=allowPaymentCodes,proto3" json:"allow_payment_codes,omitempty"`             //允许的支付方式
	CycleRepeatData       *CycleRepeatData `protobuf:"bytes,15,opt,name=cycle_repeat_data,json=cycleRepeatData,proto3" json:"cycle_repeat_data,omitempty"`                   //按周期重复数据设置
}
...
func (x *PromotionRuleConfig) GetOrderTotalAmount() float32 {
	if x != nil {
...
func (x *PromotionRuleConfig) GetOrderTotalCount() float32 {
	if x != nil {
...
func (x *PromotionRuleConfig) GetPromotionItemsTotal() float32 {
	if x != nil {
...
func (x *PromotionRuleConfig) GetIsCycleRepeat() bool {
	if x != nil {
		return x.IsCycleRepeat
	}
	return false
}
...
func (x *PromotionRuleConfig) GetCatchLimit() int32 {
	if x != nil {
		return x.CatchLimit
	}
	return 0
...
func (x *PromotionRuleConfig) GetCycleRepeatData() *CycleRepeatData {
	if x != nil {
		return x.CycleRepeatData
	}
	return nil
}

//按周期重复数据
type CycleRepeatData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	TimeType  float32 `protobuf:"fixed32,1,opt,name=time_type,json=timeType,proto3" json:"time_type,omitempty"`          //模式：1-每天,2-每周，3-每月
	BeganTime float32 `protobuf:"fixed32,2,opt,name=began_time,json=beganTime,proto3" json:"began_time,omitempty"`       //开始时间： hh:mm
	EndedTime float32 `protobuf:"fixed32,3,opt,name=ended_time,json=endedTime,proto3" json:"ended_time,omitempty"`       //结束时间： hh:mm
	PerValues []int32 `protobuf:"varint,4,rep,packed,name=per_values,json=perValues,proto3" json:"per_values,omitempty"` //具体每天数(每周和每月有效)
}

func (x *CycleRepeatData) Reset() {
	*x = CycleRepeatData{}
	if protoimpl.UnsafeEnabled {
...
func (x *CycleRepeatData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CycleRepeatData) ProtoMessage() {}

func (x *CycleRepeatData) ProtoReflect() protoreflect.Message {
	mi := &file_promotionRuleConfigService_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CycleRepeatData.ProtoReflect.Descriptor instead.
func (*CycleRepeatData) Descriptor() ([]byte, []int) {
	return file_promotionRuleConfigService_proto_rawDescGZIP(), []int{1}
}

func (x *CycleRepeatData) GetTimeType() float32 {
	if x != nil {
		return x.TimeType
	}
	return 0
...
func (x *CycleRepeatData) GetBeganTime() float32 {
	if x != nil {
		return x.BeganTime
	}
	return 0
...
func (x *CycleRepeatData) GetEndedTime() float32 {
	if x != nil {
		return x.EndedTime
	}
	return 0
...
func (x *CycleRepeatData) GetPerValues() []int32 {
	if x != nil {
		return x.PerValues
	}
	return nil
...
var file_promotionRuleConfigService_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x08, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x22, 0x92, 0x05, 0x0a,
	...
	0x6c, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x02, 0x52, 0x0f, 0x6f,
	...
	0x73, 0x5f, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x18, 0x03, 0x20, 0x01, 0x28, 0x02, 0x52, 0x13, 0x70,
	...
	,
...
var file_promotionRuleConfigService_proto_goTypes = []interface{}{
	...
	(*CycleRepeatData)(nil),     // 1: services.CycleRepeatData
}
var file_promotionRuleConfigService_proto_depIdxs = []int32{
	1, // 0: services.PromotionRuleConfig.cycle_repeat_data:type_name -> services.CycleRepeatData
