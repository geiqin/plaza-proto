...
func (x *PostRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *PostRequest) GetTop() int32 {
	if x != nil {
		return x.Top
	}
	return 0
...
func (x *PostRequest) GetType() int32 {
	if x != nil {
		return x.Type
	}
	return 0
...
var file_postService_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x17, 0x0a, 0x07, 0x64, 0x65, 0x70, 0x74,
