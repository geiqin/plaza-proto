...
func (x *NavTypeRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *NavTypeRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *NavTypeRequest) GetSorting() int32 {
	if x != nil {
		return x.Sorting
	}
	return 0
...
var file_navTypeService_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x07, 0x73, 0x6f, 0x72, 0x74, 0x69, 0x6e, 0x67, 0x12, 0x0e, 0x0a, 0x02, 0x69,
