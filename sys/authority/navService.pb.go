...
type Nav struct {
	...
	Extends     map[string]string `protobuf:"bytes,22,rep,name=extends,proto3" json:"extends,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Parent      *Nav              `protobuf:"bytes,23,opt,name=parent,proto3" json:"parent,omitempty"`
	Children    []*Nav            `protobuf:"bytes,24,rep,name=children,proto3" json:"children,omitempty"`
}
...
type NavResponse struct {
	...
	Data  *NavData      `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
