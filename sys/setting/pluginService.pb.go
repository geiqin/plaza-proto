...
type Plugin struct {
	...
	Url        string `protobuf:"bytes,11,opt,name=url,proto3" json:"url"`                                //版本
	...
	Data       string `protobuf:"bytes,14,opt,name=data,proto3" json:"data"`                              //应用数据
	Status     string `protobuf:"bytes,15,opt,name=status,proto3" json:"status"`                          //插件状态
	IsEnable   string `protobuf:"bytes,16,opt,name=is_enable,json=isEnable,proto3" json:"is_enable"`      //是否启用（0否，1是）
	IsInstall  string `protobuf:"bytes,17,opt,name=is_install,json=isInstall,proto3" json:"is_install"`   //是否已安装（0否，1是）
...
type PluginRequest struct {
	...
	IsInstall string  `protobuf:"bytes,8,opt,name=is_install,json=isInstall,proto3" json:"is_install"` //是否已安装（0否，1是）
...
func (x *PluginRequest) GetIsInstall() string {
	if x != nil {
		return x.IsInstall
	}
	return ""
...
var file_pluginService_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xd7, 0x03, 0x0a, 0x06, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x09, 0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xfe, 0x01, 0x0a,
	...
	,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x05, 0x69, 0x74,
	...
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x22, 0x5f, 0x0a, 0x0e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52,
	...
	0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74,
	...
	0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xf0, 0x03, 0x0a, 0x0d, 0x50, 0x6c, 0x75, 0x67, 0x69,
	0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x37, 0x0a, 0x07, 0x49, 0x6e, 0x73, 0x74,
	0x61, 0x6c, 0x6c, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50,
	...
	,
	...
	0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3e, 0x0a, 0x0e, 0x53, 0x61, 0x76,
	0x65, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x10, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x1a, 0x18, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3f, 0x0a, 0x08, 0x41, 0x70, 0x70, 0x53,
	0x74, 0x6f, 0x72, 0x65, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x6c, 0x75, 0x67, 0x69, 0x6e, 0x52,
...
var file_pluginService_proto_depIdxs = []int32{
	...
	0,  // 6: services.PluginService.Install:input_type -> services.Plugin
	0,  // 7: services.PluginService.Upgrade:input_type -> services.Plugin
	0,  // 8: services.PluginService.Remove:input_type -> services.Plugin
	0,  // 9: services.PluginService.Detail:input_type -> services.Plugin
	0,  // 10: services.PluginService.GetPluginData:input_type -> services.Plugin
	0,  // 11: services.PluginService.SavePluginData:input_type -> services.Plugin
	1,  // 12: services.PluginService.Search:input_type -> services.PluginRequest
	1,  // 13: services.PluginService.AppStore:input_type -> services.PluginRequest
	3,  // 14: services.PluginService.Install:output_type -> services.PluginResponse
	3,  // 15: services.PluginService.Upgrade:output_type -> services.PluginResponse
	3,  // 16: services.PluginService.Remove:output_type -> services.PluginResponse
	3,  // 17: services.PluginService.Detail:output_type -> services.PluginResponse
	3,  // 18: services.PluginService.GetPluginData:output_type -> services.PluginResponse
	3,  // 19: services.PluginService.SavePluginData:output_type -> services.PluginResponse
	3,  // 20: services.PluginService.Search:output_type -> services.PluginResponse
	3,  // 21: services.PluginService.AppStore:output_type -> services.PluginResponse
