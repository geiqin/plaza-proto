...
func (x *StreetRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *StreetRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *StreetData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StreetData) ProtoMessage() {}

func (x *StreetData) ProtoReflect() protoreflect.Message {
	mi := &file_streetService_proto_msgTypes[3]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StreetData.ProtoReflect.Descriptor instead.
func (*StreetData) Descriptor() ([]byte, []int) {
	return file_streetService_proto_rawDescGZIP(), []int{3}
}

func (x *StreetData) GetEntity() *Street {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *StreetData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *StreetData) GetItems() []*Street {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *StreetData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *StreetData) GetNewIndex() int32 {
	if x != nil {
		return x.NewIndex
	}
	return 0
...
type StreetResponse struct {
	...
	Data  *StreetData   `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *StreetResponse) Reset() {
	*x = StreetResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_streetService_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*StreetResponse) Descriptor() ([]byte, []int) {
	return file_streetService_proto_rawDescGZIP(), []int{4}
}

func (x *StreetResponse) GetData() *StreetData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *StreetResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_streetService_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x1a, 0x15, 0x61, 0x72, 0x65, 0x61, 0x49, 0x6e, 0x66, 0x6f, 0x53, 0x65, 0x72, 0x76,
	...
	0x65, 0x6e, 0x22, 0xc2, 0x01, 0x0a, 0x0a, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x44, 0x61, 0x74,
	0x61, 0x12, 0x28, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72,
	0x65, 0x65, 0x74, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x23, 0x0a, 0x05, 0x70,
	...
	0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65,
	...
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x6e, 0x65,
	0x77, 0x5f, 0x69, 0x6e, 0x64, 0x65, 0x78, 0x18, 0x05, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x6e,
	0x65, 0x77, 0x49, 0x6e, 0x64, 0x65, 0x78, 0x22, 0x5f, 0x0a, 0x0e, 0x53, 0x74, 0x72, 0x65, 0x65,
	...
	0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64,
	...
	0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xa5, 0x03, 0x0a, 0x0d, 0x53, 0x74, 0x72,
	0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x06, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x22, 0x00, 0x12, 0x36, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x1a, 0x18,
	...
	0x74, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72,
	...
	0x68, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72,
	0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70,
	...
	0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73,
	0x65, 0x22, 0x00, 0x12, 0x3b, 0x0a, 0x04, 0x54, 0x72, 0x65, 0x65, 0x12, 0x17, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x53, 0x74, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00,
...
var file_streetService_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_streetService_proto_goTypes = []interface{}{
	...
	(*StreetData)(nil),     // 3: services.StreetData
	(*StreetResponse)(nil), // 4: services.StreetResponse
...
var file_streetService_proto_depIdxs = []int32{
	5,  // 0: services.Street.area:type_name -> services.AreaInfo
	2,  // 1: services.Street.parent:type_name -> services.Street
	2,  // 2: services.Street.children:type_name -> services.Street
	2,  // 3: services.StreetData.entity:type_name -> services.Street
	6,  // 4: services.StreetData.pager:type_name -> common.Pager
	2,  // 5: services.StreetData.items:type_name -> services.Street
	7,  // 6: services.StreetData.info:type_name -> common.Info
	3,  // 7: services.StreetResponse.data:type_name -> services.StreetData
	8,  // 8: services.StreetResponse.error:type_name -> common.Error
	2,  // 9: services.StreetService.Create:input_type -> services.Street
	2,  // 10: services.StreetService.Update:input_type -> services.Street
	2,  // 11: services.StreetService.Get:input_type -> services.Street
	2,  // 12: services.StreetService.Delete:input_type -> services.Street
	0,  // 13: services.StreetService.Search:input_type -> services.StreetRequest
	0,  // 14: services.StreetService.List:input_type -> services.StreetRequest
	0,  // 15: services.StreetService.Tree:input_type -> services.StreetRequest
	4,  // 16: services.StreetService.Create:output_type -> services.StreetResponse
	4,  // 17: services.StreetService.Update:output_type -> services.StreetResponse
	4,  // 18: services.StreetService.Get:output_type -> services.StreetResponse
	4,  // 19: services.StreetService.Delete:output_type -> services.StreetResponse
	4,  // 20: services.StreetService.Search:output_type -> services.StreetResponse
	4,  // 21: services.StreetService.List:output_type -> services.StreetResponse
	4,  // 22: services.StreetService.Tree:output_type -> services.StreetResponse
...
func file_streetService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_streetService_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
