...
func (x *SlideRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *SlideRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *SlideRequest) GetSorting() int32 {
	if x != nil {
		return x.Sorting
	}
	return 0
...
func (x *SlideData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SlideData) ProtoMessage() {}

func (x *SlideData) ProtoReflect() protoreflect.Message {
	mi := &file_slideService_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SlideData.ProtoReflect.Descriptor instead.
func (*SlideData) Descriptor() ([]byte, []int) {
	return file_slideService_proto_rawDescGZIP(), []int{2}
}

func (x *SlideData) GetEntity() *Slide {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *SlideData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *SlideData) GetItems() []*Slide {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *SlideData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
type SlideResponse struct {
	...
	Data  *SlideData    `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *SlideResponse) Reset() {
	*x = SlideResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_slideService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SlideResponse) Descriptor() ([]byte, []int) {
	return file_slideService_proto_rawDescGZIP(), []int{3}
}

func (x *SlideResponse) GetData() *SlideData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SlideResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_slideService_proto_rawDesc = []byte{
	...
	0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x73, 0x6f, 0x72, 0x74, 0x69, 0x6e,
	...
	0x0b, 0x20, 0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xa2, 0x01, 0x0a, 0x09, 0x53,
	0x6c, 0x69, 0x64, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x27, 0x0a, 0x06, 0x65, 0x6e, 0x74, 0x69,
	0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74,
	...
	0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x20, 0x0a,
	...
	0x5d, 0x0a, 0x0d, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x27, 0x0a, 0x04, 0x64, 0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x44,
	...
	0x6e, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xdb,
	0x02, 0x0a, 0x0c, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	0x34, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x0f, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x1a, 0x17, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f,
	...
	,
	...
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69, 0x64, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x6c, 0x69,
...
var file_slideService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_slideService_proto_goTypes = []interface{}{
	(*Slide)(nil),         // 0: services.Slide
	(*SlideRequest)(nil),  // 1: services.SlideRequest
	(*SlideData)(nil),     // 2: services.SlideData
	(*SlideResponse)(nil), // 3: services.SlideResponse
	(*common.Pager)(nil),  // 4: common.Pager
	(*common.Info)(nil),   // 5: common.Info
	(*common.Error)(nil),  // 6: common.Error
}
var file_slideService_proto_depIdxs = []int32{
	0,  // 0: services.SlideData.entity:type_name -> services.Slide
	4,  // 1: services.SlideData.pager:type_name -> common.Pager
	0,  // 2: services.SlideData.items:type_name -> services.Slide
	5,  // 3: services.SlideData.info:type_name -> common.Info
	2,  // 4: services.SlideResponse.data:type_name -> services.SlideData
	6,  // 5: services.SlideResponse.error:type_name -> common.Error
	0,  // 6: services.SlideService.Create:input_type -> services.Slide
	0,  // 7: services.SlideService.Update:input_type -> services.Slide
	0,  // 8: services.SlideService.Delete:input_type -> services.Slide
	0,  // 9: services.SlideService.Get:input_type -> services.Slide
	1,  // 10: services.SlideService.Search:input_type -> services.SlideRequest
	1,  // 11: services.SlideService.List:input_type -> services.SlideRequest
	3,  // 12: services.SlideService.Create:output_type -> services.SlideResponse
	3,  // 13: services.SlideService.Update:output_type -> services.SlideResponse
	3,  // 14: services.SlideService.Delete:output_type -> services.SlideResponse
	3,  // 15: services.SlideService.Get:output_type -> services.SlideResponse
	3,  // 16: services.SlideService.Search:output_type -> services.SlideResponse
	3,  // 17: services.SlideService.List:output_type -> services.SlideResponse
...
func file_slideService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_slideService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
