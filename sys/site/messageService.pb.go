...
func (x *MessageRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *MessageRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *MessageRequest) GetSorting() int32 {
	if x != nil {
		return x.Sorting
	}
	return 0
...
var file_messageService_proto_rawDesc = []byte{
	...
	0x72, 0x74, 0x69, 0x6e, 0x67, 0x18, 0x03, 0x20, 0x01, 0x28, 0x05, 0x52, 0x07, 0x73, 0x6f, 0x72,
