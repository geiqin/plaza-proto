...
func (x *AnswerRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *AnswerRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *AnswerRequest) GetSorting() int32 {
	if x != nil {
		return x.Sorting
	}
	return 0
...
func (x *AnswerData) GetEntity() *Answer {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *AnswerData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *AnswerData) GetItems() []*Answer {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *AnswerData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
type AnswerResponse struct {
	...
	Data  *AnswerData   `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *AnswerResponse) Reset() {
	*x = AnswerResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_answerService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AnswerResponse) Descriptor() ([]byte, []int) {
	return file_answerService_proto_rawDescGZIP(), []int{3}
}

func (x *AnswerResponse) GetData() *AnswerData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *AnswerResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_answerService_proto_rawDesc = []byte{
	...
	0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xa5, 0x01, 0x0a, 0x0a, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72,
	...
	0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x23,
	...
	0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e,
	0x73, 0x77, 0x65, 0x72, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x20, 0x0a, 0x04, 0x69,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x44,
	...
	0x6e, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xaa,
	...
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x1a, 0x18, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x52, 0x65,
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x35, 0x0a, 0x05, 0x52, 0x65, 0x70, 0x6c,
	0x79, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73,
	0x77, 0x65, 0x72, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41,
	...
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x1a, 0x18, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65, 0x72, 0x52, 0x65, 0x73,
	...
	0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x41, 0x6e, 0x73, 0x77, 0x65,
...
var file_answerService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_answerService_proto_goTypes = []interface{}{
	(*Answer)(nil),         // 0: services.Answer
	(*AnswerRequest)(nil),  // 1: services.AnswerRequest
	(*AnswerData)(nil),     // 2: services.AnswerData
	(*AnswerResponse)(nil), // 3: services.AnswerResponse
	(*common.Pager)(nil),   // 4: common.Pager
	(*common.Info)(nil),    // 5: common.Info
	(*common.Error)(nil),   // 6: common.Error
}
var file_answerService_proto_depIdxs = []int32{
	0,  // 0: services.AnswerData.entity:type_name -> services.Answer
	4,  // 1: services.AnswerData.pager:type_name -> common.Pager
	0,  // 2: services.AnswerData.items:type_name -> services.Answer
	5,  // 3: services.AnswerData.info:type_name -> common.Info
	2,  // 4: services.AnswerResponse.data:type_name -> services.AnswerData
	6,  // 5: services.AnswerResponse.error:type_name -> common.Error
	0,  // 6: services.AnswerService.Create:input_type -> services.Answer
	0,  // 7: services.AnswerService.Reply:input_type -> services.Answer
	0,  // 8: services.AnswerService.Delete:input_type -> services.Answer
	0,  // 9: services.AnswerService.Get:input_type -> services.Answer
	1,  // 10: services.AnswerService.Search:input_type -> services.AnswerRequest
	3,  // 11: services.AnswerService.Create:output_type -> services.AnswerResponse
	3,  // 12: services.AnswerService.Reply:output_type -> services.AnswerResponse
	3,  // 13: services.AnswerService.Delete:output_type -> services.AnswerResponse
	3,  // 14: services.AnswerService.Get:output_type -> services.AnswerResponse
	3,  // 15: services.AnswerService.Search:output_type -> services.AnswerResponse
...
func file_answerService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_answerService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
