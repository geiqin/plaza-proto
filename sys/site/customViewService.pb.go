...
func (x *CustomViewRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *CustomViewRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
func (x *CustomViewRequest) GetSorting() int32 {
	if x != nil {
		return x.Sorting
	}
	return 0
...
func (x *CustomViewData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CustomViewData) ProtoMessage() {}

func (x *CustomViewData) ProtoReflect() protoreflect.Message {
	mi := &file_customViewService_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CustomViewData.ProtoReflect.Descriptor instead.
func (*CustomViewData) Descriptor() ([]byte, []int) {
	return file_customViewService_proto_rawDescGZIP(), []int{2}
}

func (x *CustomViewData) GetEntity() *CustomView {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *CustomViewData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *CustomViewData) GetItems() []*CustomView {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *CustomViewData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
type CustomViewResponse struct {
	...
	Data  *CustomViewData `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *CustomViewResponse) Reset() {
	*x = CustomViewResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_customViewService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*CustomViewResponse) Descriptor() ([]byte, []int) {
	return file_customViewService_proto_rawDescGZIP(), []int{3}
}

func (x *CustomViewResponse) GetData() *CustomViewData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *CustomViewResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_customViewService_proto_rawDesc = []byte{
	...
	0xb1, 0x01, 0x0a, 0x0e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x44, 0x61,
	...
	0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79,
	...
	0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d,
	...
	0x6e, 0x66, 0x6f, 0x22, 0x67, 0x0a, 0x12, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65,
	0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x64, 0x61, 0x74,
	0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	0x65, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x44, 0x61, 0x74,
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x9c, 0x03, 0x0a,
	0x11, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x53, 0x65, 0x72, 0x76, 0x69,
	...
	0x65, 0x77, 0x1a, 0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x75,
	0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	...
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x52,
	0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x73, 0x70,
	...
	0x56, 0x69, 0x65, 0x77, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x1c, 0x2e, 0x73, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x56, 0x69, 0x65,
	0x77, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a, 0x0b, 0x2f,
...
var file_customViewService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_customViewService_proto_goTypes = []interface{}{
	...
	(*CustomViewData)(nil),     // 2: services.CustomViewData
	(*CustomViewResponse)(nil), // 3: services.CustomViewResponse
	(*common.Pager)(nil),       // 4: common.Pager
	(*common.Info)(nil),        // 5: common.Info
	(*common.Error)(nil),       // 6: common.Error
}
var file_customViewService_proto_depIdxs = []int32{
	0,  // 0: services.CustomViewData.entity:type_name -> services.CustomView
	4,  // 1: services.CustomViewData.pager:type_name -> common.Pager
	0,  // 2: services.CustomViewData.items:type_name -> services.CustomView
	5,  // 3: services.CustomViewData.info:type_name -> common.Info
	2,  // 4: services.CustomViewResponse.data:type_name -> services.CustomViewData
	6,  // 5: services.CustomViewResponse.error:type_name -> common.Error
	0,  // 6: services.CustomViewService.Create:input_type -> services.CustomView
	0,  // 7: services.CustomViewService.Update:input_type -> services.CustomView
	0,  // 8: services.CustomViewService.Delete:input_type -> services.CustomView
	0,  // 9: services.CustomViewService.Get:input_type -> services.CustomView
	1,  // 10: services.CustomViewService.Search:input_type -> services.CustomViewRequest
	1,  // 11: services.CustomViewService.List:input_type -> services.CustomViewRequest
	3,  // 12: services.CustomViewService.Create:output_type -> services.CustomViewResponse
	3,  // 13: services.CustomViewService.Update:output_type -> services.CustomViewResponse
	3,  // 14: services.CustomViewService.Delete:output_type -> services.CustomViewResponse
	3,  // 15: services.CustomViewService.Get:output_type -> services.CustomViewResponse
	3,  // 16: services.CustomViewService.Search:output_type -> services.CustomViewResponse
	3,  // 17: services.CustomViewService.List:output_type -> services.CustomViewResponse
...
func file_customViewService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_customViewService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
