...
func (x *WarehouseRequest) GetSorts() []string {
	if x != nil {
		return x.Sorts
	}
	return nil
...
const file_warehouseService_proto_rawDesc = "" +
	"\n" +
	"\x16warehouseService.proto\x12\bservices\x1a\x11common/base.proto\"\xb4\x04\n" +
	"\tWarehouse\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x12\n" +
	"\x04name\x18\x02 \x01(\tR\x04name\x12\x14\n" +
	"\x05alias\x18\x03 \x01(\tR\x05alias\x12\x14\n" +
	"\x05level\x18\x04 \x01(\x05R\x05level\x12!\n" +
	"\fcontact_name\x18\x05 \x01(\tR\vcontactName\x12\x1f\n" +
	"\vcontact_tel\x18\x06 \x01(\tR\n" +
	"contactTel\x12\x1f\n" +
	"\vprovince_id\x18\a \x01(\x03R\n" +
	"provinceId\x12\x17\n" +
	"\acity_id\x18\b \x01(\x03R\x06cityId\x12\x1b\n" +
	"\tcounty_id\x18\t \x01(\x03R\bcountyId\x12\x18\n" +
	"\aaddress\x18\n" +
	" \x01(\tR\aaddress\x12\x10\n" +
	"\x03lng\x18\v \x01(\x02R\x03lng\x12\x10\n" +
	"\x03lat\x18\f \x01(\x02R\x03lat\x12\x1b\n" +
	"\tis_enable\x18\r \x01(\tR\bisEnable\x12\x1d\n" +
	"\n" +
	"is_default\x18\x0e \x01(\tR\tisDefault\x12!\n" +
	"\frealstore_id\x18\x0f \x01(\x03R\vrealstoreId\x12\x1d\n" +
	"\n" +
	"created_at\x18\x10 \x01(\x03R\tcreatedAt\x12\x1d\n" +
	"\n" +
	"updated_at\x18\x11 \x01(\x03R\tupdatedAt\x12#\n" +
	"\rprovince_name\x18\x12 \x01(\tR\fprovinceName\x12\x1b\n" +
	"\tcity_name\x18\x13 \x01(\tR\bcityName\x12\x1f\n" +
	"\vcounty_name\x18\x14 \x01(\tR\n" +
	"countyName\"\xe7\x03\n" +
	"\x10WarehouseRequest\x12\x10\n" +
	...
	"\x05alias\x18\f \x01(\tR\x05alias\x12!\n" +
	"\fcontact_name\x18\r \x01(\tR\vcontactName\x12\x1f\n" +
	"\vprovince_id\x18\x0e \x01(\x03R\n" +
	"provinceId\x12\x17\n" +
	"\acity_id\x18\x0f \x01(\x03R\x06cityId\x12\x1b\n" +
	"\tcounty_id\x18\x10 \x01(\x03R\bcountyId\x12\x18\n" +
	"\aaddress\x18\x11 \x01(\tR\aaddress\x12\x1b\n" +
	"\tis_enable\x18\x12 \x01(\tR\bisEnable\x12\x1d\n" +
	"\n" +
	"is_default\x18\x13 \x01(\tR\tisDefault\x12!\n" +
	"\frealstore_id\x18\x14 \x01(\x03R\vrealstoreId\"\xa2\x01\n" +
	"\x11WarehouseResponse\x12\x10\n" +
	"\x03msg\x18\x01 \x01(\tR\x03msg\x12#\n" +
	"\x05pager\x18\x02 \x01(\v2\r.common.PagerR\x05pager\x12+\n" +
	"\x06entity\x18\x03 \x01(\v2\x13.services.WarehouseR\x06entity\x12)\n" +
	"\x05items\x18\x04 \x03(\v2\x13.services.WarehouseR\x05items2\xd1\x03\n" +
	"\x10WarehouseService\x12<\n" +
	"\x06Create\x12\x13.services.Warehouse\x1a\x1b.services.WarehouseResponse\"\x00\x12<\n" +
	"\x06Update\x12\x13.services.Warehouse\x1a\x1b.services.WarehouseResponse\"\x00\x12<\n" +
	"\x06Delete\x12\x13.services.Warehouse\x1a\x1b.services.WarehouseResponse\"\x00\x129\n" +
	"\x03Get\x12\x13.services.Warehouse\x1a\x1b.services.WarehouseResponse\"\x00\x12@\n" +
	"\n" +
	"GetDefault\x12\x13.services.Warehouse\x1a\x1b.services.WarehouseResponse\"\x00\x12C\n" +
	"\x06Search\x12\x1a.services.WarehouseRequest\x1a\x1b.services.WarehouseResponse\"\x00\x12A\n" +
	"\x04List\x12\x1a.services.WarehouseRequest\x1a\x1b.services.WarehouseResponse\"\x00B\rZ\v/.;servicesb\x06proto3"

var (
	file_warehouseService_proto_rawDescOnce sync.Once
	file_warehouseService_proto_rawDescData []byte
)

func file_warehouseService_proto_rawDescGZIP() []byte {
	file_warehouseService_proto_rawDescOnce.Do(func() {
		file_warehouseService_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_warehouseService_proto_rawDesc), len(file_warehouseService_proto_rawDesc)))
	})
	return file_warehouseService_proto_rawDescData
}

var file_warehouseService_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_warehouseService_proto_goTypes = []any{
...
func file_warehouseService_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_warehouseService_proto_rawDesc), len(file_warehouseService_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
