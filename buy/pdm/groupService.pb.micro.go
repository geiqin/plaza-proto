...
type GroupService interface {
	...
	// 商品分组列表树
	ListTree(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*GroupResponse, error)
	// 商品分组选择树
	SelectTree(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*GroupResponse, error)
}
...
func (c *groupService) ListTree(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*GroupResponse, error) {
	req := c.c.NewRequest(c.name, "GroupService.ListTree", in)
	out := new(GroupResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
func (c *groupService) SelectTree(ctx context.Context, in *GroupRequest, opts ...client.CallOption) (*GroupResponse, error) {
	req := c.c.NewRequest(c.name, "GroupService.SelectTree", in)
	out := new(GroupResponse)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type GroupServiceHandler interface {
	...
	// 商品分组列表树
	ListTree(context.Context, *GroupRequest, *GroupResponse) error
	// 商品分组选择树
	SelectTree(context.Context, *GroupRequest, *GroupResponse) error
}
...
func RegisterGroupServiceHandler(s server.Server, hdlr GroupServiceHandler, opts ...server.HandlerOption) error {
	type groupService interface {
		...
		ListTree(ctx context.Context, in *GroupRequest, out *GroupResponse) error
		SelectTree(ctx context.Context, in *GroupRequest, out *GroupResponse) error
	}
	type GroupService struct {
		groupService
	}
...
func (h *groupServiceHandler) ListTree(ctx context.Context, in *GroupRequest, out *GroupResponse) error {
	return h.GroupServiceHandler.ListTree(ctx, in, out)
}

func (h *groupServiceHandler) SelectTree(ctx context.Context, in *GroupRequest, out *GroupResponse) error {
	return h.GroupServiceHandler.SelectTree(ctx, in, out)
}
