...
type BuyOrderItem struct {
	...
	TotalPrice    int64    `protobuf:"varint,8,opt,name=total_price,json=totalPrice,proto3" json:"total_price"`          //合计价格
	DiscountShare int64    `protobuf:"varint,9,opt,name=discount_share,json=discountShare,proto3" json:"discount_share"` //优惠分摊
	FinalPrice    int64    `protobuf:"varint,10,opt,name=final_price,json=finalPrice,proto3" json:"final_price"`         //支付价格
	Product       *Product `protobuf:"bytes,11,opt,name=product,proto3" json:"product"`
}
...
type CartItem struct {
	...
	SpuId    int64  `protobuf:"varint,2,opt,name=spu_id,json=spuId,proto3" json:"spu_id"`   //商品ID
	SkuKey   string `protobuf:"bytes,3,opt,name=sku_key,json=skuKey,proto3" json:"sku_key"` //规格sku_key
	Quantity int64  `protobuf:"varint,4,opt,name=quantity,proto3" json:"quantity"`          //数量
}
...
func (x *CalculatorRequest) GetMemberId() int64 {
	if x != nil {
		return x.MemberId
	}
	return 0
...
func (x *CalculatorRequest) GetCartItems() []*CartItem {
	if x != nil {
		return x.CartItems
	}
	return nil
...
type CalculatorResponse struct {
	...
	BuildBuyGroups  []*BuyGroup     `protobuf:"bytes,2,rep,name=build_buy_groups,json=buildBuyGroups,proto3" json:"build_buy_groups"`
	GetPurchaseList []*BuyOrderItem `protobuf:"bytes,3,rep,name=get_purchase_list,json=getPurchaseList,proto3" json:"get_purchase_list"`
}
...
func (x *CalculatorResponse) GetBuildBuyGroups() []*BuyGroup {
	if x != nil {
		return x.BuildBuyGroups
	}
	return nil
}

func (x *CalculatorResponse) GetGetPurchaseList() []*BuyOrderItem {
	if x != nil {
		return x.GetPurchaseList
	}
	return nil
}
...
var file_calculatorService_proto_rawDesc = []byte{
	...
	0x61, 0x6c, 0x56, 0x6f, 0x6c, 0x75, 0x6d, 0x65, 0x22, 0xea, 0x02, 0x0a, 0x0c, 0x42, 0x75, 0x79,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x72,
	...
	,
	...
	0x72, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75,
	0x6e, 0x74, 0x53, 0x68, 0x61, 0x72, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x66, 0x69, 0x6e, 0x61, 0x6c,
	0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x66, 0x69,
	0x6e, 0x61, 0x6c, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x2b, 0x0a, 0x07, 0x70, 0x72, 0x6f, 0x64,
	0x75, 0x63, 0x74, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x07, 0x70, 0x72,
	0x6f, 0x64, 0x75, 0x63, 0x74, 0x22, 0x66, 0x0a, 0x08, 0x43, 0x61, 0x72, 0x74, 0x49, 0x74, 0x65,
	...
	0x79, 0x12, 0x1a, 0x0a, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x08, 0x71, 0x75, 0x61, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x22, 0x9f, 0x01,
	...
	0x28, 0x03, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x0a,
	0x63, 0x61, 0x72, 0x74, 0x5f, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b,
	...
	,
	...
	0x4e, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x4c, 0x69,
	0x73, 0x74, 0x12, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61,
	0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	0x1c, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x6c, 0x63, 0x75,
...
var file_calculatorService_proto_goTypes = []interface{}{
	...
	(*CartItem)(nil),           // 3: services.CartItem
...
var file_calculatorService_proto_depIdxs = []int32{
	...
	3, // 4: services.CalculatorRequest.cart_items:type_name -> services.CartItem
	0, // 5: services.CalculatorResponse.build_buy_groups:type_name -> services.BuyGroup
	2, // 6: services.CalculatorResponse.get_purchase_list:type_name -> services.BuyOrderItem
	4, // 7: services.CalculatorService.BuildBuyGroups:input_type -> services.CalculatorRequest
	4, // 8: services.CalculatorService.GetPurchaseList:input_type -> services.CalculatorRequest
	5, // 9: services.CalculatorService.BuildBuyGroups:output_type -> services.CalculatorResponse
	5, // 10: services.CalculatorService.GetPurchaseList:output_type -> services.CalculatorResponse
