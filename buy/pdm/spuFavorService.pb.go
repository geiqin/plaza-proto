...
func (x *SpuFavorData) GetCount() int64 {
	if x != nil {
		return x.Count
	}
	return 0
...
type SpuFavorCollectData struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *SpuFavorCollectData) Reset() {
	*x = SpuFavorCollectData{}
	if protoimpl.UnsafeEnabled {
		mi := &file_spuFavorService_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *SpuFavorCollectData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*SpuFavorCollectData) ProtoMessage() {}

func (x *SpuFavorCollectData) ProtoReflect() protoreflect.Message {
	mi := &file_spuFavorService_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use SpuFavorCollectData.ProtoReflect.Descriptor instead.
func (*SpuFavorCollectData) Descriptor() ([]byte, []int) {
	return file_spuFavorService_proto_rawDescGZIP(), []int{4}
}

func (x *SpuFavorCollectData) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
func (x *SpuFavorCollectData) GetStatus() string {
	if x != nil {
		return x.Status
	}
	return ""
...
func (x *SpuFavorCollectData) GetText() string {
	if x != nil {
		return x.Text
	}
	return ""
...
func (x *SpuFavorCollectResponse) Reset() {
	*x = SpuFavorCollectResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_spuFavorService_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*SpuFavorCollectResponse) Descriptor() ([]byte, []int) {
	return file_spuFavorService_proto_rawDescGZIP(), []int{5}
}

func (x *SpuFavorCollectResponse) GetData() *SpuFavorCollectData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *SpuFavorCollectResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *SpuFavorCollectResponse) GetMsg() string {
	if x != nil {
		return x.Msg
	}
	return ""
...
var file_spuFavorService_proto_rawDesc = []byte{
	...
	0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x22, 0x73, 0x0a, 0x0c, 0x53, 0x70, 0x75, 0x46, 0x61, 0x76,
	0x6f, 0x72, 0x44, 0x61, 0x74, 0x61, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18,
	0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x0a, 0x05,
	...
	0x32, 0x12, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x70, 0x75, 0x46,
	0x61, 0x76, 0x6f, 0x72, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x22, 0x63, 0x0a, 0x10, 0x53,
	0x70, 0x75, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12,
	...
	,
	...
	0xd4, 0x01, 0x0a, 0x0f, 0x53, 0x70, 0x75, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x40, 0x0a, 0x07, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x12, 0x12,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x70, 0x75, 0x46, 0x61, 0x76,
	0x6f, 0x72, 0x1a, 0x21, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x70,
	0x75, 0x46, 0x61, 0x76, 0x6f, 0x72, 0x43, 0x6f, 0x6c, 0x6c, 0x65, 0x63, 0x74, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3e, 0x0a, 0x05, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x19,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x53, 0x70, 0x75, 0x46, 0x61, 0x76,
...
var file_spuFavorService_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_spuFavorService_proto_goTypes = []interface{}{
	...
	(*SpuFavorCollectData)(nil),     // 4: services.SpuFavorCollectData
	(*SpuFavorCollectResponse)(nil), // 5: services.SpuFavorCollectResponse
...
var file_spuFavorService_proto_depIdxs = []int32{
	6,  // 0: services.SpuFavor.spu:type_name -> services.Spu
	7,  // 1: services.SpuFavorData.pager:type_name -> common.Pager
	0,  // 2: services.SpuFavorData.items:type_name -> services.SpuFavor
	2,  // 3: services.SpuFavorResponse.data:type_name -> services.SpuFavorData
	8,  // 4: services.SpuFavorResponse.error:type_name -> common.Error
	4,  // 5: services.SpuFavorCollectResponse.data:type_name -> services.SpuFavorCollectData
	8,  // 6: services.SpuFavorCollectResponse.error:type_name -> common.Error
	0,  // 7: services.SpuFavorService.Collect:input_type -> services.SpuFavor
	...
	5,  // 10: services.SpuFavorService.Collect:output_type -> services.SpuFavorCollectResponse
	3,  // 11: services.SpuFavorService.Count:output_type -> services.SpuFavorResponse
...
func file_spuFavorService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_spuFavorService_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*SpuFavorCollectData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_spuFavorService_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
