...
func (x *AttachmentRequest) GetPaged() int32 {
	if x != nil {
		return x.Paged
	}
	return 0
...
func (x *AttachmentRequest) GetPageSize() int32 {
	if x != nil {
		return x.PageSize
	}
	return 0
...
var file_attachmentService_proto_rawDesc = []byte{
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x42, 0x0c, 0x5a, 0x0a,
