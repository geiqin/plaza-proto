...
type CalculatorService interface {
	//购物车计算
	Cart(ctx context.Context, in *PurchaseRequest, opts ...client.CallOption) (*CalculatorResponse, error)
	//下单购买计算
...
func (c *calculatorService) Cart(ctx context.Context, in *PurchaseRequest, opts ...client.CallOption) (*CalculatorResponse, error) {
	req := c.c.NewRequest(c.name, "CalculatorService.Cart", in)
...
type CalculatorServiceHandler interface {
	//购物车计算
	Cart(context.Context, *PurchaseRequest, *CalculatorResponse) error
	//下单购买计算
...
func RegisterCalculatorServiceHandler(s server.Server, hdlr CalculatorServiceHandler, opts ...server.HandlerOption) error {
	type calculatorService interface {
		Cart(ctx context.Context, in *PurchaseRequest, out *CalculatorResponse) error
...
func (h *calculatorServiceHandler) Cart(ctx context.Context, in *PurchaseRequest, out *CalculatorResponse) error {
	return h.CalculatorServiceHandler.Cart(ctx, in, out)
}
