...
type PurchaseResult struct {
	...
	TotalAmount   int64              `protobuf:"varint,6,opt,name=total_amount,json=totalAmount,proto3" json:"total_amount,omitempty"`        //实付金额
	ShippingFee   int64              `protobuf:"varint,7,opt,name=shipping_fee,json=shippingFee,proto3" json:"shipping_fee,omitempty"`        //运费
	InsureFee     int64              `protobuf:"varint,8,opt,name=insure_fee,json=insureFee,proto3" json:"insure_fee,omitempty"`              //保险费
	PackFee       int64              `protobuf:"varint,9,opt,name=pack_fee,json=packFee,proto3" json:"pack_fee,omitempty"`                    //包装费
	Surplus       int64              `protobuf:"varint,10,opt,name=surplus,proto3" json:"surplus,omitempty"`                                  //使用账户余额
	CouponId      int64              `protobuf:"varint,11,opt,name=coupon_id,json=couponId,proto3" json:"coupon_id,omitempty"`                //使用优惠劵ID
	CouponMoney   int64              `protobuf:"varint,12,opt,name=coupon_money,json=couponMoney,proto3" json:"coupon_money,omitempty"`       //使用优惠劵金额
	Integral      int32              `protobuf:"varint,13,opt,name=integral,proto3" json:"integral,omitempty"`                                //积分数量
	IntegralMoney int64              `protobuf:"varint,14,opt,name=integral_money,json=integralMoney,proto3" json:"integral_money,omitempty"` //积分金额
	PaidMoney     int64              `protobuf:"varint,15,opt,name=paid_money,json=paidMoney,proto3" json:"paid_money,omitempty"`             //已支付金额
	MemberId      int64              `protobuf:"varint,16,opt,name=member_id,json=memberId,proto3" json:"member_id,omitempty"`                //会员ID
	IsShipment    bool               `protobuf:"varint,17,opt,name=is_shipment,json=isShipment,proto3" json:"is_shipment,omitempty"`          //是否物流
	Details       []*PurchaseSkuInfo `protobuf:"bytes,18,rep,name=details,proto3" json:"details,omitempty"`
	Coupons       []*CouponInfo      `protobuf:"bytes,19,rep,name=coupons,proto3" json:"coupons,omitempty"`         //可获得的优惠
	Promotions    []*PromotionInfo   `protobuf:"bytes,20,rep,name=promotions,proto3" json:"promotions,omitempty"`   //参与的活动
	Adjustments   []*AdjustmentInfo  `protobuf:"bytes,21,rep,name=adjustments,proto3" json:"adjustments,omitempty"` //变动记录
	Presents      []*SkuInfo         `protobuf:"bytes,22,rep,name=presents,proto3" json:"presents,omitempty"`       //可获得的赠品
	//available
	AvailableSurplus int64        `protobuf:"varint,23,opt,name=available_surplus,json=availableSurplus,proto3" json:"available_surplus,omitempty"` //可使用的余额
	AvailablePoints  int32        `protobuf:"varint,24,opt,name=available_points,json=availablePoints,proto3" json:"available_points,omitempty"`    //可使用的积分
	AvailableCoupons *CouponInfo  `protobuf:"bytes,25,opt,name=available_coupons,json=availableCoupons,proto3" json:"available_coupons,omitempty"`  //可使用的优惠劵集合
	ShippingAddress  *AddressInfo `protobuf:"bytes,26,opt,name=shipping_address,json=shippingAddress,proto3" json:"shipping_address,omitempty"`     //订单收货地址
}
...
func (x *PurchaseResult) GetDetails() []*PurchaseSkuInfo {
	if x != nil {
		return x.Details
	}
	return nil
...
func (x *PurchaseResult) GetAvailablePoints() int32 {
	if x != nil {
...
func (x *PurchaseResult) GetShippingAddress() *AddressInfo {
	if x != nil {
...
type PurchaseSkuInfo struct {
	...
	SubtotalPrice    int64    `protobuf:"varint,8,opt,name=subtotal_price,json=subtotalPrice,proto3" json:"subtotal_price,omitempty"`
	SubtotalDiscount int64    `protobuf:"varint,9,opt,name=subtotal_discount,json=subtotalDiscount,proto3" json:"subtotal_discount,omitempty"`
	SubtotalAmount   int64    `protobuf:"varint,10,opt,name=subtotal_amount,json=subtotalAmount,proto3" json:"subtotal_amount,omitempty"`
	Sku              *SkuInfo `protobuf:"bytes,11,opt,name=sku,proto3" json:"sku,omitempty"`
}
...
func (x *PurchaseSkuInfo) GetMarketPrice() int64 {
	if x != nil {
...
func (x *PurchaseSkuInfo) GetCostPrice() int64 {
	if x != nil {
		return x.CostPrice
	}
	return 0
...
type PurchaseRequest struct {
	...
	Skus           []*PurchaseRequestSku `protobuf:"bytes,20,rep,name=skus,proto3" json:"skus,omitempty"` //需要计算的SKUS
}
...
type DisplayRequest struct {
	...
	MemberRankId int32                `protobuf:"varint,4,opt,name=member_rank_id,json=memberRankId,proto3" json:"member_rank_id,omitempty"` //会员等级ID
	Skus         []*DisplayRequestSku `protobuf:"bytes,5,rep,name=skus,proto3" json:"skus,omitempty"`                                        //需要计算的skus
}
...
type PurchaseRequestSku struct {
	...
	UniformFreight int64 `protobuf:"varint,10,opt,name=uniform_freight,json=uniformFreight,proto3" json:"uniform_freight,omitempty"`
	ExpressId      int64 `protobuf:"varint,11,opt,name=express_id,json=expressId,proto3" json:"express_id,omitempty"`
}
...
func (x *PurchaseRequestSku) GetUniformFreight() int64 {
	if x != nil {
...
func (x *PurchaseRequestSku) GetExpressId() int64 {
	if x != nil {
		return x.ExpressId
	}
	return 0
...
var file_calculatorService_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x94, 0x08, 0x0a, 0x0e, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65,
	...
	,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x12, 0x21, 0x0a,
	0x0c, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20,
	0x01, 0x28, 0x03, 0x52, 0x0b, 0x6d, 0x61, 0x72, 0x6b, 0x65, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65,
	0x12, 0x1d, 0x0a, 0x0a, 0x63, 0x6f, 0x73, 0x74, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x05,
	...
	,
	...
	0x75, 0x62, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12,
	0x37, 0x0a, 0x0a, 0x70, 0x72, 0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x18, 0x07, 0x20,
	...
	0x6f, 0x6d, 0x6f, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x22, 0x89, 0x01, 0x0a, 0x0d, 0x50, 0x72, 0x6f,
	...
	0x03, 0x74, 0x61, 0x67, 0x22, 0xa6, 0x01, 0x0a, 0x0e, 0x41, 0x64, 0x6a, 0x75, 0x73, 0x74, 0x6d,
	0x65, 0x6e, 0x74, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x6b, 0x75, 0x5f, 0x69,
	0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x73, 0x6b, 0x75, 0x49, 0x64, 0x12, 0x12,
	...
	0x69, 0x6e, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0a, 0x6f,
	...
	0x74, 0x12, 0x1a, 0x0a, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x18, 0x06, 0x20,
	0x01, 0x28, 0x08, 0x52, 0x08, 0x69, 0x6e, 0x63, 0x6c, 0x75, 0x64, 0x65, 0x64, 0x22, 0xcf, 0x07,
	...
	0x6d, 0x62, 0x65, 0x72, 0x5f, 0x72, 0x61, 0x6e, 0x6b, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01,
	...
	0x03, 0x52, 0x06, 0x73, 0x68, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x6f, 0x72, 0x64,
	0x65, 0x72, 0x49, 0x64, 0x12, 0x1a, 0x0a, 0x08, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x61, 0x6c,
	...
	0x09, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x12, 0x25, 0x0a, 0x0e, 0x70, 0x61,
	...
	,
	...
	0x10, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x6c, 0x4d,
	0x6f, 0x6e, 0x65, 0x79, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x69, 0x64, 0x5f, 0x6d, 0x6f, 0x6e,
	0x65, 0x79, 0x18, 0x11, 0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x70, 0x61, 0x69, 0x64, 0x4d, 0x6f,
	...
	0x17, 0x0a, 0x07, 0x61, 0x72, 0x65, 0x61, 0x5f, 0x69, 0x64, 0x18, 0x13, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x61, 0x72, 0x65, 0x61, 0x49, 0x64, 0x12, 0x31, 0x0a, 0x04, 0x73, 0x6b, 0x75, 0x73,
	0x18, 0x14, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1d, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x73, 0x2e, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61, 0x73, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x2e, 0x73, 0x6b, 0x75, 0x52, 0x04, 0x73, 0x6b, 0x75, 0x73, 0x1a, 0xc1, 0x02, 0x0a, 0x03,
	0x73, 0x6b, 0x75, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x6b, 0x75, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20,
	...
	0x6d, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x18, 0x06, 0x20, 0x01, 0x28,
	0x05, 0x52, 0x05, 0x73, 0x74, 0x6f, 0x63, 0x6b, 0x12, 0x1d, 0x0a, 0x0a, 0x69, 0x73, 0x5f, 0x76,
	0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x08, 0x52, 0x09, 0x69, 0x73,
	0x56, 0x69, 0x72, 0x74, 0x75, 0x61, 0x6c, 0x12, 0x26, 0x0a, 0x0f, 0x69, 0x73, 0x5f, 0x6d, 0x65,
	0x6d, 0x62, 0x65, 0x72, 0x5f, 0x72, 0x69, 0x67, 0x68, 0x74, 0x18, 0x08, 0x20, 0x01, 0x28, 0x08,
	...
	0x63, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x73, 0x4d, 0x65, 0x6d, 0x62,
	0x65, 0x72, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x27, 0x0a, 0x0f, 0x75, 0x6e, 0x69, 0x66, 0x6f,
	0x72, 0x6d, 0x5f, 0x66, 0x72, 0x65, 0x69, 0x67, 0x68, 0x74, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x0e, 0x75, 0x6e, 0x69, 0x66, 0x6f, 0x72, 0x6d, 0x46, 0x72, 0x65, 0x69, 0x67, 0x68, 0x74,
	0x12, 0x1d, 0x0a, 0x0a, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x0b,
	0x20, 0x01, 0x28, 0x03, 0x52, 0x09, 0x65, 0x78, 0x70, 0x72, 0x65, 0x73, 0x73, 0x49, 0x64, 0x22,
	0xd2, 0x02, 0x0a, 0x0e, 0x44, 0x69, 0x73, 0x70, 0x6c, 0x61, 0x79, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x06, 0x61, 0x72, 0x65, 0x61, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65,
	...
	,
	...
	,
	...
	0xe2, 0x01, 0x0a, 0x11, 0x43, 0x61, 0x6c, 0x63, 0x75, 0x6c, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65,
	0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x41, 0x0a, 0x04, 0x43, 0x61, 0x72, 0x74, 0x12, 0x19, 0x2e,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x45, 0x0a, 0x08, 0x50, 0x75, 0x72, 0x63,
	0x68, 0x61, 0x73, 0x65, 0x12, 0x19, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
...
var file_calculatorService_proto_goTypes = []interface{}{
	...
	(*AddressInfo)(nil),        // 13: services.AddressInfo
	(*common.Error)(nil),       // 14: common.Error
}
var file_calculatorService_proto_depIdxs = []int32{
	1,  // 0: services.PurchaseResult.details:type_name -> services.PurchaseSkuInfo
	...
	13, // 6: services.PurchaseResult.shipping_address:type_name -> services.AddressInfo
	12, // 7: services.PurchaseSkuInfo.sku:type_name -> services.SkuInfo
	3,  // 8: services.DisplaySkuInfo.promotions:type_name -> services.PromotionInfo
	9,  // 9: services.PurchaseRequest.skus:type_name -> services.PurchaseRequest.sku
	10, // 10: services.DisplayRequest.skus:type_name -> services.DisplayRequest.sku
	0,  // 11: services.CalculatorData.cart_result:type_name -> services.PurchaseResult
	0,  // 12: services.CalculatorData.purchase_result:type_name -> services.PurchaseResult
	2,  // 13: services.CalculatorData.display_result:type_name -> services.DisplaySkuInfo
	7,  // 14: services.CalculatorResponse.data:type_name -> services.CalculatorData
	14, // 15: services.CalculatorResponse.error:type_name -> common.Error
	5,  // 16: services.CalculatorService.Cart:input_type -> services.PurchaseRequest
	5,  // 17: services.CalculatorService.Purchase:input_type -> services.PurchaseRequest
	6,  // 18: services.CalculatorService.Display:input_type -> services.DisplayRequest
	8,  // 19: services.CalculatorService.Cart:output_type -> services.CalculatorResponse
	8,  // 20: services.CalculatorService.Purchase:output_type -> services.CalculatorResponse
	8,  // 21: services.CalculatorService.Display:output_type -> services.CalculatorResponse
