...
type ExpressService interface {
	...
	Copy(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error)
	Delete(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error)
	...
	// 设置默认使用模板
	Defaulted(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error)
	// 获取默认使用的模板
	GetDefault(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error)
}
...
func (c *expressService) Copy(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error) {
...
func (c *expressService) Delete(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error) {
...
func (c *expressService) Defaulted(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error) {
...
func (c *expressService) GetDefault(ctx context.Context, in *ExpressRequest, opts ...client.CallOption) (*ExpressResponse, error) {
...
type ExpressServiceHandler interface {
	...
	Copy(context.Context, *ExpressRequest, *ExpressResponse) error
	Delete(context.Context, *ExpressRequest, *ExpressResponse) error
	...
	// 设置默认使用模板
	Defaulted(context.Context, *ExpressRequest, *ExpressResponse) error
	// 获取默认使用的模板
	GetDefault(context.Context, *ExpressRequest, *ExpressResponse) error
}
...
func RegisterExpressServiceHandler(s server.Server, hdlr ExpressServiceHandler, opts ...server.HandlerOption) error {
	type expressService interface {
		...
		Copy(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error
		Delete(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error
		...
		Defaulted(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error
		GetDefault(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error
	}
	type ExpressService struct {
		expressService
	}
...
func (h *expressServiceHandler) Copy(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error {
	return h.ExpressServiceHandler.Copy(ctx, in, out)
}

func (h *expressServiceHandler) Delete(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error {
...
func (h *expressServiceHandler) Defaulted(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error {
	return h.ExpressServiceHandler.Defaulted(ctx, in, out)
}

func (h *expressServiceHandler) GetDefault(ctx context.Context, in *ExpressRequest, out *ExpressResponse) error {
