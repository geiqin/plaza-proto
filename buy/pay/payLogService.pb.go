...
type PayLog struct {
	...
	PayAmount        int64          `protobuf:"varint,12,opt,name=pay_amount,json=payAmount,proto3" json:"pay_amount"`                      //支付金额
...
func (x *PayLog) GetPayAmount() int64 {
	if x != nil {
		return x.PayAmount
	}
	return 0
...
var file_payLogService_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xda, 0x06, 0x0a, 0x06, 0x50, 0x61, 0x79, 0x4c, 0x6f, 0x67, 0x12, 0x0e, 0x0a,
	...
	0x70, 0x61, 0x79, 0x5f, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x09, 0x70, 0x61, 0x79, 0x41, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x1a, 0x0a, 0x08, 0x63,
