...
type Charge struct {
	...
	OrderType      int32  `protobuf:"varint,11,opt,name=order_type,json=orderType,proto3" json:"order_type,omitempty"`
	...
	RefundedAmount int64  `protobuf:"varint,22,opt,name=refunded_amount,json=refundedAmount,proto3" json:"refunded_amount,omitempty"`
...
type ChargeRequest struct {
	...
	//base params
	ChargeId       int64  `protobuf:"varint,4,opt,name=charge_id,json=chargeId,proto3" json:"charge_id,omitempty"`
	ChargeSn       string `protobuf:"bytes,5,opt,name=charge_sn,json=chargeSn,proto3" json:"charge_sn,omitempty"`
...
type ChargeResponse struct {
	...
	Data  *ChargeData   `protobuf:"bytes,1,opt,name=data,proto3" json:"data,omitempty"`
