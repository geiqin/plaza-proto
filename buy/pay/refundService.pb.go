...
type Refund struct {
	...
	TradeUserType    string `protobuf:"bytes,13,opt,name=trade_user_type,json=tradeUserType,proto3" json:"trade_user_type"`
	TradeUserId      int64  `protobuf:"varint,14,opt,name=trade_user_id,json=tradeUserId,proto3" json:"trade_user_id"`
	PayAccountId     int32  `protobuf:"varint,15,opt,name=pay_account_id,json=payAccountId,proto3" json:"pay_account_id"`
	ChannelType      string `protobuf:"bytes,16,opt,name=channel_type,json=channelType,proto3" json:"channel_type"`
	RefundReason     string `protobuf:"bytes,17,opt,name=refund_reason,json=refundReason,proto3" json:"refund_reason"`
	RefundSource     string `protobuf:"bytes,18,opt,name=refund_source,json=refundSource,proto3" json:"refund_source"`
	Attach           string `protobuf:"bytes,19,opt,name=attach,proto3" json:"attach"`
	TrxTransactionId string `protobuf:"bytes,20,opt,name=trx_transaction_id,json=trxTransactionId,proto3" json:"trx_transaction_id"` //交易方支付流水号
	TrxRefundId      string `protobuf:"bytes,21,opt,name=trx_refund_id,json=trxRefundId,proto3" json:"trx_refund_id"`                //交易方退款单号
	TrxFundsSource   string `protobuf:"bytes,22,opt,name=trx_funds_source,json=trxFundsSource,proto3" json:"trx_funds_source"`       //交易方退款资金来源
	TrxStatus        string `protobuf:"bytes,23,opt,name=trx_status,json=trxStatus,proto3" json:"trx_status"`                        //交易方退款状态
	Status           string `protobuf:"bytes,24,opt,name=status,proto3" json:"status"`
	FinishedAt       string `protobuf:"bytes,25,opt,name=finished_at,json=finishedAt,proto3" json:"finished_at"`
...
func (x *Refund) GetTrxTransactionId() string {
	if x != nil {
...
func (x *Refund) GetTrxRefundId() string {
	if x != nil {
		return x.TrxRefundId
	}
	return ""
}

func (x *Refund) GetTrxFundsSource() string {
	if x != nil {
		return x.TrxFundsSource
	}
	return ""
}

func (x *Refund) GetTrxStatus() string {
	if x != nil {
		return x.TrxStatus
	}
	return ""
...
var file_refundService_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0xbf, 0x06, 0x0a, 0x06, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x12, 0x0e, 0x0a,
	...
	,
	...
	0x6e, 0x18, 0x11, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x52,
	0x65, 0x61, 0x73, 0x6f, 0x6e, 0x12, 0x23, 0x0a, 0x0d, 0x72, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x5f,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0c, 0x72, 0x65,
	...
	,
	...
	0x65, 0x64, 0x41, 0x74, 0x22, 0xfe, 0x02, 0x0a, 0x0d, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x52,
	...
	,
	...
	0x64, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0c, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x49, 0x64, 0x22, 0xa5, 0x01, 0x0a, 0x0a, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64,
	...
	0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x52, 0x06, 0x65, 0x6e, 0x74, 0x69, 0x74, 0x79, 0x12, 0x23,
	...
	0x66, 0x75, 0x6e, 0x64, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12, 0x20, 0x0a, 0x04, 0x69,
	...
	0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x44,
	...
	0x6e, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xf3,
	0x01, 0x0a, 0x0d, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x36, 0x0a, 0x06, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x12, 0x10, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x1a, 0x18, 0x2e, 0x73,
	...
	0x66, 0x75, 0x6e, 0x64, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	...
	0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x66, 0x75, 0x6e,
	0x64, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x52, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
