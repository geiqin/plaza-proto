...
type Refund struct {
	...
	SourceOrderId       int64  `protobuf:"varint,13,opt,name=source_order_id,json=sourceOrderId,proto3" json:"source_order_id,omitempty"`
	RefundDesc          string `protobuf:"bytes,14,opt,name=refund_desc,json=refundDesc,proto3" json:"refund_desc,omitempty"`
	RefundSource        string `protobuf:"bytes,15,opt,name=refund_source,json=refundSource,proto3" json:"refund_source,omitempty"`
	Metadata            string `protobuf:"bytes,16,opt,name=metadata,proto3" json:"metadata,omitempty"`
	ReturnExtra         string `protobuf:"bytes,17,opt,name=return_extra,json=returnExtra,proto3" json:"return_extra,omitempty"`
	TransactionNo       string `protobuf:"bytes,18,opt,name=transaction_no,json=transactionNo,proto3" json:"transaction_no,omitempty"`
	SafeguardId         int64  `protobuf:"varint,19,opt,name=safeguard_id,json=safeguardId,proto3" json:"safeguard_id,omitempty"`
	SafeguardSn         string `protobuf:"bytes,20,opt,name=safeguard_sn,json=safeguardSn,proto3" json:"safeguard_sn,omitempty"`
...
type RefundRequest struct {
	...
	//base params
	SafeguardId    int64  `protobuf:"varint,4,opt,name=safeguard_id,json=safeguardId,proto3" json:"safeguard_id,omitempty"`
	SafeguardSn    string `protobuf:"bytes,5,opt,name=safeguard_sn,json=safeguardSn,proto3" json:"safeguard_sn,omitempty"`
	SourceOrderId  int64  `protobuf:"varint,6,opt,name=source_order_id,json=sourceOrderId,proto3" json:"source_order_id,omitempty"`
	Status         string `protobuf:"bytes,7,opt,name=status,proto3" json:"status,omitempty"`
	OrderId        int64  `protobuf:"varint,8,opt,name=order_id,json=orderId,proto3" json:"order_id,omitempty"`
	RefundSn       string `protobuf:"bytes,9,opt,name=refund_sn,json=refundSn,proto3" json:"refund_sn,omitempty"`
