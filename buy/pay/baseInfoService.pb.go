...
type ChargeInfo struct {
	...
	OrderType      string `protobuf:"bytes,1,opt,name=order_type,json=orderType,proto3" json:"order_type,omitempty"`                  //订单类型
	...
	Subject        string `protobuf:"bytes,6,opt,name=subject,proto3" json:"subject,omitempty"`                                       //支付标题
	Body           string `protobuf:"bytes,7,opt,name=body,proto3" json:"body,omitempty"`                                             //主体描述
	Extra          string `protobuf:"bytes,8,opt,name=extra,proto3" json:"extra,omitempty"`                                           //扩展信息
	TargetUserType string `protobuf:"bytes,9,opt,name=target_user_type,json=targetUserType,proto3" json:"target_user_type,omitempty"` //目标用户类型
	TargetUserId   int64  `protobuf:"varint,10,opt,name=target_user_id,json=targetUserId,proto3" json:"target_user_id,omitempty"`     //目标用户ID
}
...
func (x *ChargeInfo) GetExtra() string {
	if x != nil {
		return x.Extra
	}
	return ""
...
var file_baseInfoService_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xa9, 0x02, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x72, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x18, 0x08, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x78, 0x74, 0x72, 0x61, 0x12, 0x28, 0x0a,
	0x10, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x74, 0x79, 0x70,
	0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55,
	0x73, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x24, 0x0a, 0x0e, 0x74, 0x61, 0x72, 0x67, 0x65,
	0x74, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52,
	0x0c, 0x74, 0x61, 0x72, 0x67, 0x65, 0x74, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x0d, 0x5a,
