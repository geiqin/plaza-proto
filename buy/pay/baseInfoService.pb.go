...
type ChargeInfo struct {
	...
	TradeUserType string `protobuf:"bytes,9,opt,name=trade_user_type,json=tradeUserType,proto3" json:"trade_user_type"` //交易用户类型
	TradeUserId   int64  `protobuf:"varint,10,opt,name=trade_user_id,json=tradeUserId,proto3" json:"trade_user_id"`     //交易用户ID
}
...
func (x *ChargeInfo) GetTradeUserType() string {
	if x != nil {
...
func (x *ChargeInfo) GetTradeUserId() int64 {
	if x != nil {
...
var file_baseInfoService_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xa7, 0x02, 0x0a, 0x0a, 0x43, 0x68, 0x61, 0x72, 0x67, 0x65, 0x49, 0x6e, 0x66, 0x6f,
	...
	0x26, 0x0a, 0x0f, 0x74, 0x72, 0x61, 0x64, 0x65, 0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x74, 0x79,
	0x70, 0x65, 0x18, 0x09, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x74, 0x72, 0x61, 0x64, 0x65, 0x55,
	0x73, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x22, 0x0a, 0x0d, 0x74, 0x72, 0x61, 0x64, 0x65,
	0x5f, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b,
	0x74, 0x72, 0x61, 0x64, 0x65, 0x55, 0x73, 0x65, 0x72, 0x49, 0x64, 0x42, 0x0d, 0x5a, 0x0b, 0x2f,
