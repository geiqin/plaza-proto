...
func (x *PaymentChannelInfo) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *PaymentChannelInfo) GetChannelCode() string {
	if x != nil {
...
func (x *PaymentChannelInfo) GetChannelName() string {
	if x != nil {
...
func (x *PaymentChannelInfo) GetPaymentType() string {
	if x != nil {
...
func (x *PaymentChannelInfo) GetIconUrl() string {
	if x != nil {
		return x.IconUrl
	}
	return ""
...
func (x *PaymentChannelInfo) GetUniappProvider() string {
	if x != nil {
...
func (x *PaymentChannelInfo) GetDesc() string {
	if x != nil {
		return x.Desc
	}
	return ""
...
func (x *PaymentChannelInfo) GetSort() int32 {
	if x != nil {
		return x.Sort
	}
	return 0
...
func (x *PaymentChannelInfo) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *PaymentChannelInfo) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
...
var file_baseInfoService_proto_rawDesc = []byte{
	...
	0x73, 0x22, 0xb7, 0x02, 0x0a, 0x12, 0x50, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x43, 0x68, 0x61,
	0x6e, 0x6e, 0x65, 0x6c, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x05, 0x52, 0x02, 0x69, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x68, 0x61, 0x6e,
	0x6e, 0x65, 0x6c, 0x5f, 0x63, 0x6f, 0x64, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x63, 0x68, 0x61, 0x6e, 0x6e, 0x65, 0x6c, 0x43, 0x6f, 0x64, 0x65, 0x12, 0x21, 0x0a, 0x0c, 0x63,
	...
	0x01, 0x28, 0x09, 0x52, 0x07, 0x69, 0x63, 0x6f, 0x6e, 0x55, 0x72, 0x6c, 0x12, 0x27, 0x0a, 0x0f,
	0x75, 0x6e, 0x69, 0x61, 0x70, 0x70, 0x5f, 0x70, 0x72, 0x6f, 0x76, 0x69, 0x64, 0x65, 0x72, 0x18,
	0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0e, 0x75, 0x6e, 0x69, 0x61, 0x70, 0x70, 0x50, 0x72, 0x6f,
	0x76, 0x69, 0x64, 0x65, 0x72, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x65, 0x73, 0x63, 0x18, 0x07, 0x20,
	...
	0x52, 0x09, 0x75, 0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x42, 0x0d, 0x5a, 0x0b, 0x2f,
...
var file_baseInfoService_proto_goTypes = []interface{}{
	(*PaymentChannelInfo)(nil), // 0: services.PaymentChannelInfo
}
...
func file_baseInfoService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_baseInfoService_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*PaymentChannelInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
