...
type MemberIdentity struct {
	...
	UpdatedAt         string `protobuf:"bytes,21,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at"`                         //修改时间
}
...
func (x *MemberIdentity) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
func (x *MemberIdentity) GetUpdatedAt() string {
	if x != nil {
		return x.UpdatedAt
	}
	return ""
