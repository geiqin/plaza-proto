...
func (x *LevelOrderLogData) Reset() {
	*x = LevelOrderLogData{}
	if protoimpl.UnsafeEnabled {
...
func (x *LevelOrderLogData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LevelOrderLogData) ProtoMessage() {}

func (x *LevelOrderLogData) ProtoReflect() protoreflect.Message {
	mi := &file_levelOrderLogService_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LevelOrderLogData.ProtoReflect.Descriptor instead.
func (*LevelOrderLogData) Descriptor() ([]byte, []int) {
	return file_levelOrderLogService_proto_rawDescGZIP(), []int{2}
}

func (x *LevelOrderLogData) GetEntity() *LevelOrderLog {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *LevelOrderLogData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *LevelOrderLogData) GetItems() []*LevelOrderLog {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *LevelOrderLogData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
type LevelOrderLogResponse struct {
	...
	Data  *LevelOrderLogData `protobuf:"bytes,1,opt,name=data,proto3" json:"data"`
...
func (x *LevelOrderLogResponse) Reset() {
	*x = LevelOrderLogResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_levelOrderLogService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*LevelOrderLogResponse) Descriptor() ([]byte, []int) {
	return file_levelOrderLogService_proto_rawDescGZIP(), []int{3}
}

func (x *LevelOrderLogResponse) GetData() *LevelOrderLogData {
	if x != nil {
		return x.Data
	}
	return nil
...
func (x *LevelOrderLogResponse) GetError() *common.Error {
	if x != nil {
		return x.Error
	}
	return nil
...
var file_levelOrderLogService_proto_rawDesc = []byte{
	...
	0x64, 0x44, 0x61, 0x74, 0x65, 0x22, 0xba, 0x01, 0x0a, 0x11, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x4f,
	0x72, 0x64, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x44, 0x61, 0x74, 0x61, 0x12, 0x2f, 0x0a, 0x06, 0x65,
	...
	0x32, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4c, 0x65, 0x76, 0x65,
	0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c, 0x6f, 0x67, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73,
	...
	0x66, 0x6f, 0x22, 0x6d, 0x0a, 0x15, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x4c, 0x6f, 0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2f, 0x0a, 0x04, 0x64,
	0x61, 0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x1b, 0x2e, 0x73, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x73, 0x2e, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4c,
	...
	0x72, 0x32, 0xb2, 0x02, 0x0a, 0x14, 0x4c, 0x65, 0x76, 0x65, 0x6c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x4c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x44, 0x0a, 0x06, 0x49, 0x6e,
	0x63, 0x6f, 0x6d, 0x65, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	...
	,
...
var file_levelOrderLogService_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_levelOrderLogService_proto_goTypes = []interface{}{
	...
	(*LevelOrderLogData)(nil),     // 2: services.LevelOrderLogData
	(*LevelOrderLogResponse)(nil), // 3: services.LevelOrderLogResponse
...
var file_levelOrderLogService_proto_depIdxs = []int32{
	4,  // 0: services.LevelOrderLog.member:type_name -> services.Member
	0,  // 1: services.LevelOrderLogData.entity:type_name -> services.LevelOrderLog
	5,  // 2: services.LevelOrderLogData.pager:type_name -> common.Pager
	0,  // 3: services.LevelOrderLogData.items:type_name -> services.LevelOrderLog
	6,  // 4: services.LevelOrderLogData.info:type_name -> common.Info
	2,  // 5: services.LevelOrderLogResponse.data:type_name -> services.LevelOrderLogData
	7,  // 6: services.LevelOrderLogResponse.error:type_name -> common.Error
	0,  // 7: services.LevelOrderLogService.Income:input_type -> services.LevelOrderLog
	0,  // 8: services.LevelOrderLogService.Expend:input_type -> services.LevelOrderLog
	0,  // 9: services.LevelOrderLogService.Get:input_type -> services.LevelOrderLog
	1,  // 10: services.LevelOrderLogService.Search:input_type -> services.LevelOrderLogRequest
	3,  // 11: services.LevelOrderLogService.Income:output_type -> services.LevelOrderLogResponse
	3,  // 12: services.LevelOrderLogService.Expend:output_type -> services.LevelOrderLogResponse
	3,  // 13: services.LevelOrderLogService.Get:output_type -> services.LevelOrderLogResponse
	3,  // 14: services.LevelOrderLogService.Search:output_type -> services.LevelOrderLogResponse
...
func file_levelOrderLogService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_levelOrderLogService_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LevelOrderLogData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_levelOrderLogService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
