...
type Order struct {
	...
	RealstoreId       int64  `protobuf:"varint,5,opt,name=realstore_id,json=realstoreId,proto3" json:"realstore_id"`                    //多门店ID(依赖多门店插件)
	WarehouseId       int64  `protobuf:"varint,6,opt,name=warehouse_id,json=warehouseId,proto3" json:"warehouse_id"`                    //仓库ID
	BuyNumberCount    int32  `protobuf:"varint,7,opt,name=buy_number_count,json=buyNumberCount,proto3" json:"buy_number_count"`         //购买商品总数量
	...
	IncreasePrice     int64  `protobuf:"varint,10,opt,name=increase_price,json=increasePrice,proto3" json:"increase_price"`             //增加的金额
	PreferentialPrice int64  `protobuf:"varint,11,opt,name=preferential_price,json=preferentialPrice,proto3" json:"preferential_price"` //优惠金额
	PaidMoney         int64  `protobuf:"varint,12,opt,name=paid_money,json=paidMoney,proto3" json:"paid_money"`                         //已支付金额
	RefundedMoney     int64  `protobuf:"varint,13,opt,name=refunded_money,json=refundedMoney,proto3" json:"refunded_money"`             //已退款金额
	ReturnedNumber    int32  `protobuf:"varint,14,opt,name=returned_number,json=returnedNumber,proto3" json:"returned_number"`          //已退货数量
	DeliveredNumber   int32  `protobuf:"varint,15,opt,name=delivered_number,json=deliveredNumber,proto3" json:"delivered_number"`       //已发货数量
	ClientType        string `protobuf:"bytes,16,opt,name=client_type,json=clientType,proto3" json:"client_type"`                       //客户端类型（pc, h5, ios, android, alipay, weixin, baidu）取APPLICATION_CLIENT_TYPE常量值
	OrderModel        string `protobuf:"bytes,17,opt,name=order_model,json=orderModel,proto3" json:"order_model"`                       //订单模式（0销售型, 1展示型, 2自提点, 3虚拟销售）
	Subject           string `protobuf:"bytes,18,opt,name=subject,proto3" json:"subject"`                                               //订单标题(为支付提供标题)。
	CoverUrl          string `protobuf:"bytes,19,opt,name=cover_url,json=coverUrl,proto3" json:"cover_url"`                             //订单商品封面URL（默认取商品明细里数量最多的商品主图）
	UserNote          string `protobuf:"bytes,20,opt,name=user_note,json=userNote,proto3" json:"user_note"`                             //订单附言,由用户提交订单前填写
	SellerNote        string `protobuf:"bytes,21,opt,name=seller_note,json=sellerNote,proto3" json:"seller_note"`                       //商家留言,当该字段值时可以在订单查询看到
	DeliveryMethod    string `protobuf:"bytes,22,opt,name=delivery_method,json=deliveryMethod,proto3" json:"delivery_method"`           //配送方式：0-无须配送，1-快递发货，2-即时配送，3-上门自提
	IsUnderLine       string `protobuf:"bytes,23,opt,name=is_under_line,json=isUnderLine,proto3" json:"is_under_line"`                  //是否线下支付（0否，1是）(如果多次支付以第一次为准)
	IsCod             string `protobuf:"bytes,24,opt,name=is_cod,json=isCod,proto3" json:"is_cod"`                                      //是否货到付款
	IsInvoiced        string `protobuf:"bytes,25,opt,name=is_invoiced,json=isInvoiced,proto3" json:"is_invoiced"`                       //是否已过开票
	IsRefunded        string `protobuf:"bytes,26,opt,name=is_refunded,json=isRefunded,proto3" json:"is_refunded"`                       //是否已产生退款
	IsModifyAddress   string `protobuf:"bytes,27,opt,name=is_modify_address,json=isModifyAddress,proto3" json:"is_modify_address"`      //是否手动修改过订单地址
	IsModifyPrice     string `protobuf:"bytes,28,opt,name=is_modify_price,json=isModifyPrice,proto3" json:"is_modify_price"`            //是否手动修改过订单价
	PaymentId         int32  `protobuf:"varint,29,opt,name=payment_id,json=paymentId,proto3" json:"payment_id"`                         //用户选择的支付方式的id,取值表payment
	PayStatus         string `protobuf:"bytes,30,opt,name=pay_status,json=payStatus,proto3" json:"pay_status"`                          //支付状态（0未支付, 1已支付, 2已退款, 3部分退款）
	Status            string `protobuf:"bytes,31,opt,name=status,proto3" json:"status"`                                                 //订单状态（0待确认, 1已确认/待支付, 2已支付/待发货, 3已发货/待收货, 4已完成, 5已取消, 6已关闭）
	PayTime           string `protobuf:"bytes,32,opt,name=pay_time,json=payTime,proto3" json:"pay_time"`                                //支付时间
	ConfirmTime       string `protobuf:"bytes,33,opt,name=confirm_time,json=confirmTime,proto3" json:"confirm_time"`                    //订单确认时间
	DeliveryTime      string `protobuf:"bytes,34,opt,name=delivery_time,json=deliveryTime,proto3" json:"delivery_time"`                 //发货时间
	CancelTime        string `protobuf:"bytes,35,opt,name=cancel_time,json=cancelTime,proto3" json:"cancel_time"`                       //取消时间
	CollectTime       string `protobuf:"bytes,36,opt,name=collect_time,json=collectTime,proto3" json:"collect_time"`                    //收货时间
	CloseTime         string `protobuf:"bytes,37,opt,name=close_time,json=closeTime,proto3" json:"close_time"`                          //退款完成时间
	FinishedTime      string `protobuf:"bytes,38,opt,name=finished_time,json=finishedTime,proto3" json:"finished_time"`                 //订单完成时间
	...
	//--ext---
	IsCanLaunchAftersale bool              `protobuf:"varint,42,opt,name=is_can_launch_aftersale,json=isCanLaunchAftersale,proto3" json:"is_can_launch_aftersale"` //是否启动售后服务
	ClientTypeName       string            `protobuf:"bytes,43,opt,name=client_type_name,json=clientTypeName,proto3" json:"client_type_name"`                      //来源终端
	StatusName           string            `protobuf:"bytes,44,opt,name=status_name,json=statusName,proto3" json:"status_name"`                                    //状态名称
	StatusColor          string            `protobuf:"bytes,45,opt,name=status_color,json=statusColor,proto3" json:"status_color"`                                 //状态颜色
	PayStatusName        string            `protobuf:"bytes,46,opt,name=pay_status_name,json=payStatusName,proto3" json:"pay_status_name"`                         //状态名称
	DeliveryMethodName   string            `protobuf:"bytes,47,opt,name=delivery_method_name,json=deliveryMethodName,proto3" json:"delivery_method_name"`          //配送方式名称
	Currency             *OrderCurrency    `protobuf:"bytes,50,opt,name=currency,proto3" json:"currency"`
	Address              *OrderAddress     `protobuf:"bytes,51,opt,name=address,proto3" json:"address"`
	Member               *MemberInfo       `protobuf:"bytes,52,opt,name=member,proto3" json:"member"`
	Payment              *PaymentInfo      `protobuf:"bytes,53,opt,name=payment,proto3" json:"payment"`
	Details              []*OrderDetail    `protobuf:"bytes,54,rep,name=details,proto3" json:"details"`
	ExtensionData        []*OrderExtension `protobuf:"bytes,55,rep,name=extension_data,json=extensionData,proto3" json:"extension_data"`
	Metas                map[string]string `protobuf:"bytes,56,rep,name=metas,proto3" json:"metas" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	WarehouseData        *WarehouseInfo    `protobuf:"bytes,57,opt,name=warehouse_data,json=warehouseData,proto3" json:"warehouse_data"`
	OperateData          map[string]string `protobuf:"bytes,58,rep,name=operate_data,json=operateData,proto3" json:"operate_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Packets              []*OrderPacket    `protobuf:"bytes,59,rep,name=packets,proto3" json:"packets"`
}
...
func (x *Order) GetReturnedNumber() int32 {
	if x != nil {
...
func (x *Order) GetDeliveredNumber() int32 {
	if x != nil {
...
func (x *Order) GetDeliveryMethodName() string {
	if x != nil {
...
type OrderRequest struct {
	...
	DeliveryMethod string  `protobuf:"bytes,20,opt,name=delivery_method,json=deliveryMethod,proto3" json:"delivery_method"` //配送方式：0-无须配送，1-快递发货，2-即时配送，3-上门自提
	...
	IsNoLogistic   string  `protobuf:"bytes,35,opt,name=is_no_logistic,json=isNoLogistic,proto3" json:"is_no_logistic"` //是否无需物流（0否，1是）
}
...
func (x *OrderRequest) GetIsNoLogistic() string {
	if x != nil {
		return x.IsNoLogistic
	}
	return ""
}
...
type OrderPacket struct {
	...
	DeliveryMethod string              `protobuf:"bytes,3,opt,name=delivery_method,json=deliveryMethod,proto3" json:"delivery_method"` //配送方式：0-无须配送，1-快递发货，2-即时配送，3-上门自提
	ExpressId      int32               `protobuf:"varint,4,opt,name=express_id,json=expressId,proto3" json:"express_id"`               //快递id
	ExpressCode    string              `protobuf:"bytes,5,opt,name=express_code,json=expressCode,proto3" json:"express_code"`          //快递编号
	ExpressName    string              `protobuf:"bytes,6,opt,name=express_name,json=expressName,proto3" json:"express_name"`          //快递名称
	ExpressNumber  string              `protobuf:"bytes,7,opt,name=express_number,json=expressNumber,proto3" json:"express_number"`    //快递单号
	ExtensionCode  string              `protobuf:"bytes,8,opt,name=extension_code,json=extensionCode,proto3" json:"extension_code"`    //取货码
	GoodsCount     int32               `protobuf:"varint,9,opt,name=goods_count,json=goodsCount,proto3" json:"goods_count"`            //商品数量
	GoodsList      []*OrderPacketGoods `protobuf:"bytes,10,rep,name=goods_list,json=goodsList,proto3" json:"goods_list"`               //商品内容
	IsNoLogistic   string              `protobuf:"bytes,11,opt,name=is_no_logistic,json=isNoLogistic,proto3" json:"is_no_logistic"`    //是否无需要物流
...
func (x *OrderPacket) GetDeliveryMethod() string {
	if x != nil {
		return x.DeliveryMethod
	}
	return ""
...
func (x *OrderPacket) GetGoodsCount() int32 {
	if x != nil {
		return x.GoodsCount
	}
	return 0
...
func (x *OrderPacket) GetIsNoLogistic() string {
	if x != nil {
		return x.IsNoLogistic
	}
	return ""
...
type OrderPacketGoods struct {
	...
	Number   int32  `protobuf:"varint,7,opt,name=number,proto3" json:"number"`                     //商品数量
...
func (x *OrderPacketGoods) GetNumber() int32 {
	if x != nil {
		return x.Number
	}
	return 0
...
var file_orderService_proto_rawDesc = []byte{
	...
	0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xd5, 0x11,
	...
	0x4e, 0x6f, 0x12, 0x1b, 0x0a, 0x09, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18,
	0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x08, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x64, 0x12,
	0x17, 0x0a, 0x07, 0x73, 0x68, 0x6f, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x06, 0x73, 0x68, 0x6f, 0x70, 0x49, 0x64, 0x12, 0x21, 0x0a, 0x0c, 0x72, 0x65, 0x61, 0x6c,
	0x73, 0x74, 0x6f, 0x72, 0x65, 0x5f, 0x69, 0x64, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0b,
	...
	,
	...
	,
	...
	,
	...
	0x20, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x70, 0x61, 0x79, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x21,
	0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x21,
	...
	,
	...
	0x12, 0x30, 0x0a, 0x07, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x33, 0x20, 0x01, 0x28,
	...
	0x73, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x18, 0x34, 0x20, 0x01,
	...
	0x12, 0x2f, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x35, 0x20, 0x01, 0x28,
	...
	0x74, 0x12, 0x2f, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x36, 0x20, 0x03,
	...
	0x64, 0x61, 0x74, 0x61, 0x18, 0x37, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x73, 0x65, 0x72,
	...
	0x61, 0x74, 0x61, 0x12, 0x30, 0x0a, 0x05, 0x6d, 0x65, 0x74, 0x61, 0x73, 0x18, 0x38, 0x20, 0x03,
	...
	0x73, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x39, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e,
	...
	0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3a, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x73, 0x65,
	...
	0x63, 0x6b, 0x65, 0x74, 0x73, 0x18, 0x3b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b, 0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76,
	0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75,
	0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xf9, 0x06, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52,
	...
	,
	...
	0x70, 0x64, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x22, 0xdb, 0x01, 0x0a, 0x10, 0x4f, 0x72, 0x64,
	0x65, 0x72, 0x50, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x47, 0x6f, 0x6f, 0x64, 0x73, 0x12, 0x1b, 0x0a,
	0x09, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03,
	0x52, 0x08, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x49, 0x64, 0x12, 0x15, 0x0a, 0x06, 0x73, 0x70,
	...
	,
	...
	,
	...
	0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x32, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65,
	0x72, 0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73,
	...
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x06, 0x20, 0x03,
	...
	,
	...
	0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x79, 0x6d,
	0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x54, 0x79, 0x70, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x69,
	0x73, 0x5f, 0x73, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x18, 0x04, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x09, 0x69, 0x73, 0x53, 0x75, 0x63, 0x63, 0x65, 0x73, 0x73, 0x12, 0x3a, 0x0a, 0x06, 0x70, 0x61,
	0x72, 0x61, 0x6d, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x22, 0x2e, 0x73, 0x65, 0x72,
	...
	,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x69, 0x0a, 0x13, 0x4f, 0x72, 0x64, 0x65, 0x72,
	...
	0x6f, 0x72, 0x22, 0x63, 0x0a, 0x10, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x79, 0x52, 0x65,
	...
	0x74, 0x61, 0x12, 0x23, 0x0a, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x0b, 0x32, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72,
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x7b, 0x0a, 0x1c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x53, 0x74, 0x65, 0x70, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x52,
	...
	0x54, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12,
	...
	,
	...
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x44, 0x61,
	...
	0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x92, 0x0a,
...
var file_orderService_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_orderService_proto_goTypes = []interface{}{
	(*Order)(nil),                        // 0: services.Order
	(*OrderRequest)(nil),                 // 1: services.OrderRequest
	(*OrderPacket)(nil),                  // 2: services.OrderPacket
	(*OrderPacketGoods)(nil),             // 3: services.OrderPacketGoods
	(*OrderStatusStepTotalData)(nil),     // 4: services.OrderStatusStepTotalData
	(*OrderData)(nil),                    // 5: services.OrderData
	(*OrderDetailData)(nil),              // 6: services.OrderDetailData
	(*OrderPayData)(nil),                 // 7: services.OrderPayData
	(*OrderResponse)(nil),                // 8: services.OrderResponse
	(*OrderDetailResponse)(nil),          // 9: services.OrderDetailResponse
	(*OrderPayResponse)(nil),             // 10: services.OrderPayResponse
	(*OrderStatusStepTotalResponse)(nil), // 11: services.OrderStatusStepTotalResponse
	(*OrderExtensionData)(nil),           // 12: services.OrderExtensionData
	(*OrderExtensionResponse)(nil),       // 13: services.OrderExtensionResponse
	nil,                                  // 14: services.Order.MetasEntry
	nil,                                  // 15: services.Order.OperateDataEntry
	nil,                                  // 16: services.OrderPayData.ParamsEntry
	(*OrderCurrency)(nil),                // 17: services.OrderCurrency
	(*OrderAddress)(nil),                 // 18: services.OrderAddress
	(*MemberInfo)(nil),                   // 19: services.MemberInfo
	(*PaymentInfo)(nil),                  // 20: services.PaymentInfo
	(*OrderDetail)(nil),                  // 21: services.OrderDetail
	(*OrderExtension)(nil),               // 22: services.OrderExtension
	(*WarehouseInfo)(nil),                // 23: services.WarehouseInfo
	(*common.Pager)(nil),                 // 24: common.Pager
	(*common.Info)(nil),                  // 25: common.Info
	(*OrderFlow)(nil),                    // 26: services.OrderFlow
	(*common.Error)(nil),                 // 27: common.Error
}
var file_orderService_proto_depIdxs = []int32{
	17, // 0: services.Order.currency:type_name -> services.OrderCurrency
	18, // 1: services.Order.address:type_name -> services.OrderAddress
	19, // 2: services.Order.member:type_name -> services.MemberInfo
	20, // 3: services.Order.payment:type_name -> services.PaymentInfo
	21, // 4: services.Order.details:type_name -> services.OrderDetail
	22, // 5: services.Order.extension_data:type_name -> services.OrderExtension
	14, // 6: services.Order.metas:type_name -> services.Order.MetasEntry
	23, // 7: services.Order.warehouse_data:type_name -> services.WarehouseInfo
	15, // 8: services.Order.operate_data:type_name -> services.Order.OperateDataEntry
	2,  // 9: services.Order.packets:type_name -> services.OrderPacket
	3,  // 10: services.OrderPacket.goods_list:type_name -> services.OrderPacketGoods
	0,  // 11: services.OrderData.entity:type_name -> services.Order
	24, // 12: services.OrderData.pager:type_name -> common.Pager
	0,  // 13: services.OrderData.items:type_name -> services.Order
	25, // 14: services.OrderData.info:type_name -> common.Info
	26, // 15: services.OrderData.order_flow:type_name -> services.OrderFlow
	20, // 16: services.OrderData.payment_list:type_name -> services.PaymentInfo
	0,  // 17: services.OrderDetailData.order:type_name -> services.Order
	25, // 18: services.OrderDetailData.info:type_name -> common.Info
	26, // 19: services.OrderDetailData.order_flow:type_name -> services.OrderFlow
	20, // 20: services.OrderDetailData.payment_list:type_name -> services.PaymentInfo
	16, // 21: services.OrderPayData.params:type_name -> services.OrderPayData.ParamsEntry
	20, // 22: services.OrderPayData.payment:type_name -> services.PaymentInfo
	5,  // 23: services.OrderResponse.data:type_name -> services.OrderData
	27, // 24: services.OrderResponse.error:type_name -> common.Error
	6,  // 25: services.OrderDetailResponse.data:type_name -> services.OrderDetailData
	27, // 26: services.OrderDetailResponse.error:type_name -> common.Error
	7,  // 27: services.OrderPayResponse.data:type_name -> services.OrderPayData
	27, // 28: services.OrderPayResponse.error:type_name -> common.Error
	4,  // 29: services.OrderStatusStepTotalResponse.data:type_name -> services.OrderStatusStepTotalData
	27, // 30: services.OrderStatusStepTotalResponse.error:type_name -> common.Error
	22, // 31: services.OrderExtensionData.entity:type_name -> services.OrderExtension
	22, // 32: services.OrderExtensionData.items:type_name -> services.OrderExtension
	12, // 33: services.OrderExtensionResponse.data:type_name -> services.OrderExtensionData
	27, // 34: services.OrderExtensionResponse.error:type_name -> common.Error
	1,  // 35: services.OrderService.OrderPay:input_type -> services.OrderRequest
	1,  // 36: services.OrderService.OrderUnderLinePay:input_type -> services.OrderRequest
	2,  // 37: services.OrderService.OrderDelivery:input_type -> services.OrderPacket
	1,  // 38: services.OrderService.OrderCancel:input_type -> services.OrderRequest
	1,  // 39: services.OrderService.OrderDelete:input_type -> services.OrderRequest
	1,  // 40: services.OrderService.OrderConfirm:input_type -> services.OrderRequest
	1,  // 41: services.OrderService.OrderCollect:input_type -> services.OrderRequest
	1,  // 42: services.OrderService.OrderPayCheck:input_type -> services.OrderRequest
	0,  // 43: services.OrderService.ModifyOrderPrice:input_type -> services.Order
	18, // 44: services.OrderService.ModifyOrderAddress:input_type -> services.OrderAddress
	1,  // 45: services.OrderService.OrderStatusStepTotal:input_type -> services.OrderRequest
	1,  // 46: services.OrderService.OrderTotal:input_type -> services.OrderRequest
	1,  // 47: services.OrderService.OrderSearch:input_type -> services.OrderRequest
	1,  // 48: services.OrderService.OrderDetail:input_type -> services.OrderRequest
	1,  // 49: services.OrderService.Respond:input_type -> services.OrderRequest
	1,  // 50: services.OrderService.Notify:input_type -> services.OrderRequest
	0,  // 51: services.OrderService.Get:input_type -> services.Order
	1,  // 52: services.OrderService.List:input_type -> services.OrderRequest
	1,  // 53: services.OrderService.OrderExtensionList:input_type -> services.OrderRequest
	10, // 54: services.OrderService.OrderPay:output_type -> services.OrderPayResponse
	8,  // 55: services.OrderService.OrderUnderLinePay:output_type -> services.OrderResponse
	8,  // 56: services.OrderService.OrderDelivery:output_type -> services.OrderResponse
	8,  // 57: services.OrderService.OrderCancel:output_type -> services.OrderResponse
	8,  // 58: services.OrderService.OrderDelete:output_type -> services.OrderResponse
	8,  // 59: services.OrderService.OrderConfirm:output_type -> services.OrderResponse
	8,  // 60: services.OrderService.OrderCollect:output_type -> services.OrderResponse
	8,  // 61: services.OrderService.OrderPayCheck:output_type -> services.OrderResponse
	8,  // 62: services.OrderService.ModifyOrderPrice:output_type -> services.OrderResponse
	8,  // 63: services.OrderService.ModifyOrderAddress:output_type -> services.OrderResponse
	11, // 64: services.OrderService.OrderStatusStepTotal:output_type -> services.OrderStatusStepTotalResponse
	8,  // 65: services.OrderService.OrderTotal:output_type -> services.OrderResponse
	8,  // 66: services.OrderService.OrderSearch:output_type -> services.OrderResponse
	9,  // 67: services.OrderService.OrderDetail:output_type -> services.OrderDetailResponse
	8,  // 68: services.OrderService.Respond:output_type -> services.OrderResponse
	8,  // 69: services.OrderService.Notify:output_type -> services.OrderResponse
	8,  // 70: services.OrderService.Get:output_type -> services.OrderResponse
	8,  // 71: services.OrderService.List:output_type -> services.OrderResponse
	13, // 72: services.OrderService.OrderExtensionList:output_type -> services.OrderExtensionResponse
