...
type Order struct {
	...
	DeliveryMode      string `protobuf:"bytes,23,opt,name=delivery_mode,json=deliveryMode,proto3" json:"delivery_mode"`                 //发货模式：1-统一发货，2-分拆发货
	IsAllDelivered    string `protobuf:"bytes,24,opt,name=is_all_delivered,json=isAllDelivered,proto3" json:"is_all_delivered"`         //是否已全部发货(发货模式为2时有效)（0否，1是）
	IsUnderLine       string `protobuf:"bytes,25,opt,name=is_under_line,json=isUnderLine,proto3" json:"is_under_line"`                  //是否线下支付（0否，1是）(如果多次支付以第一次为准)
	IsCod             string `protobuf:"bytes,26,opt,name=is_cod,json=isCod,proto3" json:"is_cod"`                                      //是否货到付款
	IsInvoiced        string `protobuf:"bytes,27,opt,name=is_invoiced,json=isInvoiced,proto3" json:"is_invoiced"`                       //是否已过开票（0否，1是）
	IsRefunded        string `protobuf:"bytes,28,opt,name=is_refunded,json=isRefunded,proto3" json:"is_refunded"`                       //是否已产生退款（0否，1是）
	IsModifyAddress   string `protobuf:"bytes,29,opt,name=is_modify_address,json=isModifyAddress,proto3" json:"is_modify_address"`      //是否手动修改过订单地址（0否，1是）
	IsModifyPrice     string `protobuf:"bytes,30,opt,name=is_modify_price,json=isModifyPrice,proto3" json:"is_modify_price"`            //是否手动修改过订单价（0否，1是）
	PaymentId         int32  `protobuf:"varint,31,opt,name=payment_id,json=paymentId,proto3" json:"payment_id"`                         //用户选择的支付方式的id,取值表payment
	PayStatus         string `protobuf:"bytes,32,opt,name=pay_status,json=payStatus,proto3" json:"pay_status"`                          //支付状态（0未支付, 1已支付, 2已退款, 3部分退款）
	Status            string `protobuf:"bytes,33,opt,name=status,proto3" json:"status"`                                                 //订单状态（0待确认, 1已确认/待支付, 2已支付/待发货, 3已发货/待收货, 4已完成, 5已取消, 6已关闭）
	PayTime           string `protobuf:"bytes,34,opt,name=pay_time,json=payTime,proto3" json:"pay_time"`                                //支付时间
	ConfirmTime       string `protobuf:"bytes,35,opt,name=confirm_time,json=confirmTime,proto3" json:"confirm_time"`                    //订单确认时间
	DeliveryTime      string `protobuf:"bytes,36,opt,name=delivery_time,json=deliveryTime,proto3" json:"delivery_time"`                 //发货时间
	CancelTime        string `protobuf:"bytes,37,opt,name=cancel_time,json=cancelTime,proto3" json:"cancel_time"`                       //取消时间
	CollectTime       string `protobuf:"bytes,38,opt,name=collect_time,json=collectTime,proto3" json:"collect_time"`                    //收货时间
	CloseTime         string `protobuf:"bytes,39,opt,name=close_time,json=closeTime,proto3" json:"close_time"`                          //退款完成时间
	FinishedTime      string `protobuf:"bytes,40,opt,name=finished_time,json=finishedTime,proto3" json:"finished_time"`                 //订单完成时间
	CreatedAt         string `protobuf:"bytes,41,opt,name=created_at,json=createdAt,proto3" json:"created_at"`
	UpdatedAt         string `protobuf:"bytes,42,opt,name=updated_at,json=updatedAt,proto3" json:"updated_at"`
	//--ext---
	IsCanLaunchAftersale bool              `protobuf:"varint,44,opt,name=is_can_launch_aftersale,json=isCanLaunchAftersale,proto3" json:"is_can_launch_aftersale"` //是否启动售后服务
	ClientTypeName       string            `protobuf:"bytes,45,opt,name=client_type_name,json=clientTypeName,proto3" json:"client_type_name"`                      //来源终端
	StatusName           string            `protobuf:"bytes,46,opt,name=status_name,json=statusName,proto3" json:"status_name"`                                    //状态名称
	StatusColor          string            `protobuf:"bytes,47,opt,name=status_color,json=statusColor,proto3" json:"status_color"`                                 //状态颜色
	PayStatusName        string            `protobuf:"bytes,48,opt,name=pay_status_name,json=payStatusName,proto3" json:"pay_status_name"`                         //状态名称
	LogisticsTypeName    string            `protobuf:"bytes,49,opt,name=logistics_type_name,json=logisticsTypeName,proto3" json:"logistics_type_name"`             //物流模式名称
	DeliveryModeName     string            `protobuf:"bytes,50,opt,name=delivery_mode_name,json=deliveryModeName,proto3" json:"delivery_mode_name"`                //发货模式名称
	Currency             *OrderCurrency    `protobuf:"bytes,51,opt,name=currency,proto3" json:"currency"`
	Address              *OrderAddress     `protobuf:"bytes,52,opt,name=address,proto3" json:"address"`
	Member               *MemberInfo       `protobuf:"bytes,53,opt,name=member,proto3" json:"member"`
	Payment              *PaymentInfo      `protobuf:"bytes,54,opt,name=payment,proto3" json:"payment"`
	Details              []*OrderDetail    `protobuf:"bytes,55,rep,name=details,proto3" json:"details"`
	ExtensionData        []*OrderExtension `protobuf:"bytes,56,rep,name=extension_data,json=extensionData,proto3" json:"extension_data"`
	Metas                map[string]string `protobuf:"bytes,57,rep,name=metas,proto3" json:"metas" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	WarehouseData        *WarehouseInfo    `protobuf:"bytes,58,opt,name=warehouse_data,json=warehouseData,proto3" json:"warehouse_data"`
	OperateData          map[string]string `protobuf:"bytes,59,rep,name=operate_data,json=operateData,proto3" json:"operate_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Packets              []*OrderPacket    `protobuf:"bytes,60,rep,name=packets,proto3" json:"packets"`
}
...
var file_orderService_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xce, 0x12, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65,
	...
	,
	...
	0x0f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0f, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x65, 0x64,
	0x4e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x63, 0x6c, 0x69, 0x65, 0x6e, 0x74,
	...
	,
	...
	,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x18, 0x1d, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0f, 0x69, 0x73, 0x4d,
	...
	0x1e, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x69, 0x73, 0x4d, 0x6f, 0x64, 0x69, 0x66, 0x79, 0x50,
	0x72, 0x69, 0x63, 0x65, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f,
	0x69, 0x64, 0x18, 0x1f, 0x20, 0x01, 0x28, 0x05, 0x52, 0x09, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e,
	0x74, 0x49, 0x64, 0x12, 0x1d, 0x0a, 0x0a, 0x70, 0x61, 0x79, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x75,
	0x73, 0x18, 0x20, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x70, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74,
	...
	,
	...
	,
	...
	0x69, 0x65, 0x6e, 0x74, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x2d,
	...
	,
	...
	0x64, 0x72, 0x65, 0x73, 0x73, 0x12, 0x2c, 0x0a, 0x06, 0x6d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x18,
	0x35, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x06, 0x6d, 0x65, 0x6d,
	0x62, 0x65, 0x72, 0x12, 0x2f, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x18, 0x36,
	...
	0x6d, 0x65, 0x6e, 0x74, 0x12, 0x2f, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18,
	0x37, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x52, 0x07, 0x64, 0x65,
	0x74, 0x61, 0x69, 0x6c, 0x73, 0x12, 0x3f, 0x0a, 0x0e, 0x65, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69,
	0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x38, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e,
	...
	0x6f, 0x6e, 0x44, 0x61, 0x74, 0x61, 0x12, 0x30, 0x0a, 0x05, 0x6d, 0x65, 0x74, 0x61, 0x73, 0x18,
	0x39, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73,
	0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x73, 0x45, 0x6e, 0x74, 0x72,
	0x79, 0x52, 0x05, 0x6d, 0x65, 0x74, 0x61, 0x73, 0x12, 0x3e, 0x0a, 0x0e, 0x77, 0x61, 0x72, 0x65,
	0x68, 0x6f, 0x75, 0x73, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3a, 0x20, 0x01, 0x28, 0x0b,
	...
	0x6f, 0x75, 0x73, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x43, 0x0a, 0x0c, 0x6f, 0x70, 0x65, 0x72,
	0x61, 0x74, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x20,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6f, 0x6e, 0x2e, 0x49, 0x6e, 0x66, 0x6f, 0x52, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x12, 0x32, 0x0a,
	0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x05, 0x20, 0x01, 0x28,
	...
	0x70, 0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xc8, 0x01, 0x0a, 0x0f,
	...
	0x05, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x12, 0x20, 0x0a, 0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x02,
	...
	0x6e, 0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0xe4, 0x02, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x50, 0x61, 0x79, 0x44, 0x61, 0x74, 0x61, 0x12, 0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f, 0x12, 0x21, 0x0a,
	...
	,
	...
	0x78, 0x74, 0x1a, 0x39, 0x0a, 0x0b, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x45, 0x6e, 0x74, 0x72,
	...
	0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x69, 0x0a, 0x13,
	...
	0x65, 0x72, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	...
	0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x63, 0x0a, 0x10, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x50, 0x61, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x2a, 0x0a, 0x04, 0x64,
	...
	,
	...
	,
	...
	0x6f, 0x72, 0x32, 0x92, 0x0a, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76,
	...
	,
...
var file_orderService_proto_goTypes = []interface{}{
	...
	(*common.Info)(nil),                  // 24: common.Info
	(*OrderFlow)(nil),                    // 25: services.OrderFlow
...
var file_orderService_proto_depIdxs = []int32{
	...
	24, // 13: services.OrderData.info:type_name -> common.Info
	25, // 14: services.OrderData.order_flow:type_name -> services.OrderFlow
	18, // 15: services.OrderData.payment_list:type_name -> services.PaymentInfo
	0,  // 16: services.OrderDetailData.order:type_name -> services.Order
	24, // 17: services.OrderDetailData.info:type_name -> common.Info
	25, // 18: services.OrderDetailData.order_flow:type_name -> services.OrderFlow
	18, // 19: services.OrderDetailData.payment_list:type_name -> services.PaymentInfo
	14, // 20: services.OrderPayData.params:type_name -> services.OrderPayData.ParamsEntry
	18, // 21: services.OrderPayData.payment:type_name -> services.PaymentInfo
	3,  // 22: services.OrderResponse.data:type_name -> services.OrderData
	26, // 23: services.OrderResponse.error:type_name -> common.Error
	4,  // 24: services.OrderDetailResponse.data:type_name -> services.OrderDetailData
	26, // 25: services.OrderDetailResponse.error:type_name -> common.Error
	5,  // 26: services.OrderPayResponse.data:type_name -> services.OrderPayData
	26, // 27: services.OrderPayResponse.error:type_name -> common.Error
	2,  // 28: services.OrderStatusStepTotalResponse.data:type_name -> services.OrderStatusStepTotalData
	26, // 29: services.OrderStatusStepTotalResponse.error:type_name -> common.Error
	20, // 30: services.OrderExtensionData.entity:type_name -> services.OrderExtension
	20, // 31: services.OrderExtensionData.items:type_name -> services.OrderExtension
	10, // 32: services.OrderExtensionResponse.data:type_name -> services.OrderExtensionData
	26, // 33: services.OrderExtensionResponse.error:type_name -> common.Error
	...
	1,  // 52: services.OrderService.OrderExtensionList:input_type -> services.OrderRequest
	8,  // 53: services.OrderService.OrderPay:output_type -> services.OrderPayResponse
	6,  // 54: services.OrderService.OrderUnderLinePay:output_type -> services.OrderResponse
	6,  // 55: services.OrderService.OrderDelivery:output_type -> services.OrderResponse
	6,  // 56: services.OrderService.OrderCancel:output_type -> services.OrderResponse
	6,  // 57: services.OrderService.OrderDelete:output_type -> services.OrderResponse
	6,  // 58: services.OrderService.OrderConfirm:output_type -> services.OrderResponse
	6,  // 59: services.OrderService.OrderCollect:output_type -> services.OrderResponse
	6,  // 60: services.OrderService.OrderPayCheck:output_type -> services.OrderResponse
	6,  // 61: services.OrderService.ModifyOrderPrice:output_type -> services.OrderResponse
	6,  // 62: services.OrderService.ModifyOrderAddress:output_type -> services.OrderResponse
	9,  // 63: services.OrderService.OrderStatusStepTotal:output_type -> services.OrderStatusStepTotalResponse
	6,  // 64: services.OrderService.OrderTotal:output_type -> services.OrderResponse
	6,  // 65: services.OrderService.OrderSearch:output_type -> services.OrderResponse
	7,  // 66: services.OrderService.OrderDetail:output_type -> services.OrderDetailResponse
	6,  // 67: services.OrderService.Respond:output_type -> services.OrderResponse
	6,  // 68: services.OrderService.Notify:output_type -> services.OrderResponse
	6,  // 69: services.OrderService.Get:output_type -> services.OrderResponse
	6,  // 70: services.OrderService.List:output_type -> services.OrderResponse
	11, // 71: services.OrderService.OrderExtensionList:output_type -> services.OrderExtensionResponse
