...
type Order struct {
	...
	BuyNumberCount    int64  `protobuf:"varint,7,opt,name=buy_number_count,json=buyNumberCount,proto3" json:"buy_number_count"`         //购买商品总数量
	...
	ReturnedNumber    int64  `protobuf:"varint,14,opt,name=returned_number,json=returnedNumber,proto3" json:"returned_number"`          //已退货数量
	DeliveredNumber   int64  `protobuf:"varint,15,opt,name=delivered_number,json=deliveredNumber,proto3" json:"delivered_number"`       //已发货数量
...
var file_orderService_proto_rawDesc = []byte{
	...
	0x62, 0x65, 0x72, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52,
	...
	0x65, 0x72, 0x18, 0x0e, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0e, 0x72, 0x65, 0x74, 0x75, 0x72, 0x6e,
