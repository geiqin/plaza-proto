...
type Order struct {
	...
	DeliveredNumber   int64   `protobuf:"varint,18,opt,name=delivered_number,json=deliveredNumber,proto3" json:"delivered_number"`       //已发货数量
	ClientType        string  `protobuf:"bytes,19,opt,name=client_type,json=clientType,proto3" json:"client_type"`                       //客户端类型（pc, h5, ios, android, alipay, weixin, baidu）取APPLICATION_CLIENT_TYPE常量值
	OrderModel        string  `protobuf:"bytes,20,opt,name=order_model,json=orderModel,proto3" json:"order_model"`                       //订单模式（0销售型, 1展示型, 2自提点, 3虚拟销售）
	Subject           string  `protobuf:"bytes,21,opt,name=subject,proto3" json:"subject"`                                               //订单标题(为支付提供标题)。
	CoverUrl          string  `protobuf:"bytes,22,opt,name=cover_url,json=coverUrl,proto3" json:"cover_url"`                             //订单商品封面URL（默认取商品明细里数量最多的商品主图）
	UserNote          string  `protobuf:"bytes,23,opt,name=user_note,json=userNote,proto3" json:"user_note"`                             //订单附言,由用户提交订单前填写
	SellerNote        string  `protobuf:"bytes,24,opt,name=seller_note,json=sellerNote,proto3" json:"seller_note"`                       //商家留言,当该字段值时可以在订单查询看到
	LogisticsType     string  `protobuf:"bytes,25,opt,name=logistics_type,json=logisticsType,proto3" json:"logistics_type"`              //物流模式：1-物流快递，2-同城配送，3-虚拟发货，4-用户自提
	DeliveryMode      string  `protobuf:"bytes,26,opt,name=delivery_mode,json=deliveryMode,proto3" json:"delivery_mode"`                 //发货模式：1-统一发货，2-分拆发货
	IsAllDelivered    string  `protobuf:"bytes,27,opt,name=is_all_delivered,json=isAllDelivered,proto3" json:"is_all_delivered"`         //是否已全部发货(发货模式为2时有效)（0否，1是）
	IsUnderLine       string  `protobuf:"bytes,28,opt,name=is_under_line,json=isUnderLine,proto3" json:"is_under_line"`                  //是否线下支付（0否，1是）(如果多次支付以第一次为准)
	IsCod             string  `protobuf:"bytes,29,opt,name=is_cod,json=isCod,proto3" json:"is_cod"`                                      //是否货到付款
	IsInvoiced        string  `protobuf:"bytes,30,opt,name=is_invoiced,json=isInvoiced,proto3" json:"is_invoiced"`                       //是否已过开票（0否，1是）
	IsRefunded        string  `protobuf:"bytes,31,opt,name=is_refunded,json=isRefunded,proto3" json:"is_refunded"`                       //是否已产生退款（0否，1是）
	IsModifyAddress   string  `protobuf:"bytes,32,opt,name=is_modify_address,json=isModifyAddress,proto3" json:"is_modify_address"`      //是否手动修改过订单地址（0否，1是）
	IsModifyPrice     string  `protobuf:"bytes,33,opt,name=is_modify_price,json=isModifyPrice,proto3" json:"is_modify_price"`            //是否手动修改过订单价（0否，1是）
	...
	//--ext---
	IsCanLaunchAftersale bool              `protobuf:"varint,46,opt,name=is_can_launch_aftersale,json=isCanLaunchAftersale,proto3" json:"is_can_launch_aftersale"` //是否启动售后服务
	ClientTypeName       string            `protobuf:"bytes,47,opt,name=client_type_name,json=clientTypeName,proto3" json:"client_type_name"`                      //来源终端
	StatusName           string            `protobuf:"bytes,48,opt,name=status_name,json=statusName,proto3" json:"status_name"`                                    //状态名称
	StatusColor          string            `protobuf:"bytes,49,opt,name=status_color,json=statusColor,proto3" json:"status_color"`                                 //状态颜色
	PayStatusName        string            `protobuf:"bytes,50,opt,name=pay_status_name,json=payStatusName,proto3" json:"pay_status_name"`                         //状态名称
	LogisticsTypeName    string            `protobuf:"bytes,51,opt,name=logistics_type_name,json=logisticsTypeName,proto3" json:"logistics_type_name"`             //物流模式名称
	DeliveryModeName     string            `protobuf:"bytes,52,opt,name=delivery_mode_name,json=deliveryModeName,proto3" json:"delivery_mode_name"`                //发货模式名称
	Currency             *OrderCurrency    `protobuf:"bytes,53,opt,name=currency,proto3" json:"currency"`
	Address              *OrderAddress     `protobuf:"bytes,54,opt,name=address,proto3" json:"address"`
	Member               *MemberInfo       `protobuf:"bytes,55,opt,name=member,proto3" json:"member"`
	Payment              *PaymentInfo      `protobuf:"bytes,56,opt,name=payment,proto3" json:"payment"`
	Details              []*OrderDetail    `protobuf:"bytes,57,rep,name=details,proto3" json:"details"`
	ExtensionData        []*OrderExtension `protobuf:"bytes,58,rep,name=extension_data,json=extensionData,proto3" json:"extension_data"`
	Metas                map[string]string `protobuf:"bytes,59,rep,name=metas,proto3" json:"metas" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	WarehouseData        *WarehouseInfo    `protobuf:"bytes,60,opt,name=warehouse_data,json=warehouseData,proto3" json:"warehouse_data"`
	OperateData          map[string]string `protobuf:"bytes,61,rep,name=operate_data,json=operateData,proto3" json:"operate_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	Packets              []*OrderPacket    `protobuf:"bytes,62,rep,name=packets,proto3" json:"packets"`
}
...
var file_orderService_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xf2, 0x12, 0x0a, 0x05, 0x4f, 0x72, 0x64, 0x65,
	...
	,
	...
	,
	...
	,
	...
	0x32, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x70, 0x61, 0x79, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73,
	0x4e, 0x61, 0x6d, 0x65, 0x12, 0x2e, 0x0a, 0x13, 0x6c, 0x6f, 0x67, 0x69, 0x73, 0x74, 0x69, 0x63,
	0x73, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x33, 0x20, 0x01, 0x28,
	...
	0x5f, 0x6d, 0x6f, 0x64, 0x65, 0x5f, 0x6e, 0x61, 0x6d, 0x65, 0x18, 0x34, 0x20, 0x01, 0x28, 0x09,
	0x52, 0x10, 0x64, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x79, 0x4d, 0x6f, 0x64, 0x65, 0x4e, 0x61,
	0x6d, 0x65, 0x12, 0x33, 0x0a, 0x08, 0x63, 0x75, 0x72, 0x72, 0x65, 0x6e, 0x63, 0x79, 0x18, 0x35,
	...
	0x73, 0x73, 0x18, 0x36, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x62, 0x65, 0x72, 0x18, 0x37, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x6e, 0x74, 0x18, 0x38, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	...
	0x69, 0x6c, 0x73, 0x18, 0x39, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x15, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3a, 0x20, 0x03, 0x28,
	...
	0x74, 0x61, 0x73, 0x18, 0x3b, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x73, 0x65, 0x72, 0x76,
	...
	0x77, 0x61, 0x72, 0x65, 0x68, 0x6f, 0x75, 0x73, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3c,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	...
	0x6f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x65, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x18, 0x3d, 0x20, 0x03,
	...
	0x61, 0x12, 0x2f, 0x0a, 0x07, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x18, 0x3e, 0x20, 0x03,
	...
	0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6b,
	0x65, 0x79, 0x12, 0x14, 0x0a, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x05, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0xa0, 0x07, 0x0a,
	...
	0x0e, 0x69, 0x73, 0x41, 0x6c, 0x6c, 0x44, 0x65, 0x6c, 0x69, 0x76, 0x65, 0x72, 0x65, 0x64, 0x22,
	0xda, 0x03, 0x0a, 0x18, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x53,
	0x74, 0x65, 0x70, 0x54, 0x6f, 0x74, 0x61, 0x6c, 0x44, 0x61, 0x74, 0x61, 0x12, 0x1b, 0x0a, 0x09,
	...
	,
	...
	0x65, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d, 0x73, 0x12,
	0x19, 0x0a, 0x08, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28,
	0x03, 0x52, 0x07, 0x6f, 0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x6f, 0x72,
	0x64, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x03, 0x52, 0x08, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x49, 0x64, 0x73, 0x12, 0x32, 0x0a, 0x0a, 0x6f, 0x72, 0x64, 0x65, 0x72,
	0x5f, 0x66, 0x6c, 0x6f, 0x77, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x65,
	...
	0x61, 0x79, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x07, 0x20, 0x03, 0x28,
	...
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x73, 0x67, 0x18, 0x08, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x22, 0xc8, 0x01, 0x0a, 0x0f, 0x4f, 0x72, 0x64, 0x65,
	...
	0x6e, 0x2e, 0x45, 0x72, 0x72, 0x6f, 0x72, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0x98,
	0x0b, 0x0a, 0x0c, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12,
	...
	0x12, 0x40, 0x0a, 0x08, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x50, 0x61, 0x79, 0x12, 0x16, 0x2e, 0x73,
	...
	0x22, 0x00, 0x12, 0x46, 0x0a, 0x11, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x55, 0x6e, 0x64, 0x65, 0x72,
	0x4c, 0x69, 0x6e, 0x65, 0x50, 0x61, 0x79, 0x12, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x22, 0x00, 0x12, 0x43, 0x0a, 0x0e, 0x4e, 0x65, 0x77, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x4e, 0x6f,
	0x74, 0x69, 0x63, 0x65, 0x12, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e,
	0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x17, 0x2e, 0x73,
	0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x50, 0x0a, 0x12, 0x4f, 0x72, 0x64, 0x65, 0x72,
	0x45, 0x78, 0x74, 0x65, 0x6e, 0x73, 0x69, 0x6f, 0x6e, 0x4c, 0x69, 0x73, 0x74, 0x12, 0x16, 0x2e,
