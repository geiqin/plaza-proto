...
type OrderBase struct {
	...
	Address           *OrderAddress     `protobuf:"bytes,14,opt,name=address,proto3" json:"address"`                                              //收件地址
	ExtractionAddress []*OrderAddress   `protobuf:"bytes,15,rep,name=extraction_address,json=extractionAddress,proto3" json:"extraction_address"` //自提点地址
	ExtensionData     []*OrderExtension `protobuf:"bytes,16,rep,name=extension_data,json=extensionData,proto3" json:"extension_data"`             //扩展数据
}
...
type BuyConfirmData struct {
	...
	ExtensionData         map[string]string      `protobuf:"bytes,9,rep,name=extension_data,json=extensionData,proto3" json:"extension_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"` //扩展数据
	PluginsData           map[string]string      `protobuf:"bytes,10,rep,name=plugins_data,json=pluginsData,proto3" json:"plugins_data" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`      //插件数据
	...
	IntegralData          *IntegralData          `protobuf:"bytes,14,opt,name=integral_data,json=integralData,proto3" json:"integral_data"`                                                                                           //积分兑换数据
}
...
func (x *BuyConfirmData) GetExtensionData() map[string]string {
	if x != nil {
		return x.ExtensionData
	}
	return nil
...
func (x *BuyConfirmData) GetPluginsData() map[string]string {
	if x != nil {
...
func (x *BuyConfirmData) GetIntegralData() *IntegralData {
	if x != nil {
...
type IntegralData struct {
	...
	ActualUseIntegral      int64  `protobuf:"varint,1,opt,name=actual_use_integral,json=actualUseIntegral,proto3" json:"actual_use_integral"`                 //实际使用积分
	...
	UserIntegral           int64  `protobuf:"varint,4,opt,name=user_integral,json=userIntegral,proto3" json:"user_integral"`                                  //用户积分
	IsSupportGoodsExchange string `protobuf:"bytes,5,opt,name=is_support_goods_exchange,json=isSupportGoodsExchange,proto3" json:"is_support_goods_exchange"` //是否支持积分兑换（0否，1是）
	DiscountType           string `protobuf:"bytes,6,opt,name=discount_type,json=discountType,proto3" json:"discount_type"`                                   //积分优惠类型（0抵现，1兑换）
}

func (x *IntegralData) Reset() {
	*x = IntegralData{}
	if protoimpl.UnsafeEnabled {
...
func (x *IntegralData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegralData) ProtoMessage() {}

func (x *IntegralData) ProtoReflect() protoreflect.Message {
	mi := &file_buyService_proto_msgTypes[7]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntegralData.ProtoReflect.Descriptor instead.
func (*IntegralData) Descriptor() ([]byte, []int) {
	return file_buyService_proto_rawDescGZIP(), []int{7}
}

func (x *IntegralData) GetActualUseIntegral() int64 {
	if x != nil {
...
func (x *IntegralData) GetUseIntegral() int64 {
	if x != nil {
		return x.UseIntegral
	}
	return 0
...
func (x *IntegralData) GetDiscountPrice() int64 {
	if x != nil {
...
func (x *IntegralData) GetUserIntegral() int64 {
	if x != nil {
...
func (x *IntegralData) GetIsSupportGoodsExchange() string {
	if x != nil {
...
func (x *IntegralData) GetDiscountType() string {
	if x != nil {
...
type IntegralDeductionData struct {
	...
	DeductionList       *IntegralDeductionDataGoods `protobuf:"bytes,5,opt,name=deduction_list,json=deductionList,proto3" json:"deduction_list"`                     //抵扣列表
}
...
func (x *IntegralDeductionData) GetDeductionList() *IntegralDeductionDataGoods {
	if x != nil {
		return x.DeductionList
	}
	return nil
}
...
type IntegralDeductionDataGoods struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *IntegralDeductionDataGoods) Reset() {
	*x = IntegralDeductionDataGoods{}
	if protoimpl.UnsafeEnabled {
		mi := &file_buyService_proto_msgTypes[16]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}

func (x *IntegralDeductionDataGoods) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*IntegralDeductionDataGoods) ProtoMessage() {}

func (x *IntegralDeductionDataGoods) ProtoReflect() protoreflect.Message {
	mi := &file_buyService_proto_msgTypes[16]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use IntegralDeductionDataGoods.ProtoReflect.Descriptor instead.
func (*IntegralDeductionDataGoods) Descriptor() ([]byte, []int) {
	return file_buyService_proto_rawDescGZIP(), []int{8, 0}
}

func (x *IntegralDeductionDataGoods) GetSpuId() int64 {
	if x != nil {
		return x.SpuId
	}
	return 0
...
func (x *IntegralDeductionDataGoods) GetMd5Key() string {
	if x != nil {
		return x.Md5Key
	}
	return ""
...
func (x *IntegralDeductionDataGoods) GetDiscountPrice() int64 {
	if x != nil {
		return x.DiscountPrice
	}
	return 0
...
var file_buyService_proto_rawDesc = []byte{
	...
	0x6f, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x86,
	0x03, 0x0a, 0x08, 0x42, 0x75, 0x79, 0x47, 0x72, 0x6f, 0x75, 0x70, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x64, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x22, 0xb6, 0x07, 0x0a, 0x0c, 0x42, 0x75, 0x79, 0x47,
	0x6f, 0x6f, 0x64, 0x73, 0x49, 0x74, 0x65, 0x6d, 0x12, 0x17, 0x0a, 0x07, 0x63, 0x61, 0x72, 0x74,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x6e, 0x44, 0x61, 0x74, 0x61, 0x22, 0xc6, 0x05, 0x0a, 0x0a, 0x42, 0x75, 0x79, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x19, 0x0a, 0x08, 0x62, 0x75, 0x79, 0x5f, 0x74, 0x79, 0x70, 0x65,
	0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x62, 0x75, 0x79, 0x54, 0x79, 0x70, 0x65, 0x12,
	...
	0x0a, 0x09, 0x75, 0x73, 0x65, 0x72, 0x5f, 0x6e, 0x6f, 0x74, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x75, 0x73, 0x65, 0x72, 0x4e, 0x6f, 0x74, 0x65, 0x12, 0x1f, 0x0a, 0x0b, 0x73,
	0x68, 0x69, 0x70, 0x6d, 0x65, 0x6e, 0x74, 0x5f, 0x69, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x05,
	...
	,
	...
	,
	...
	0x08, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x4d, 0x73, 0x67, 0x1a, 0x46, 0x0a, 0x04, 0x69, 0x74, 0x65,
	...
	0x65, 0x22, 0xdc, 0x06, 0x0a, 0x0e, 0x42, 0x75, 0x79, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x72, 0x6d,
	0x44, 0x61, 0x74, 0x61, 0x12, 0x27, 0x0a, 0x04, 0x62, 0x61, 0x73, 0x65, 0x18, 0x01, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x13, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x4f, 0x72,
	0x64, 0x65, 0x72, 0x42, 0x61, 0x73, 0x65, 0x52, 0x04, 0x62, 0x61, 0x73, 0x65, 0x12, 0x31, 0x0a,
	0x0a, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x02, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x12, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x42, 0x75, 0x79,
	...
	,
	...
	,
	...
	0x67, 0x72, 0x61, 0x6c, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x69, 0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74,
	0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0d, 0x64, 0x69,
	0x73, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x75,
	0x73, 0x65, 0x72, 0x5f, 0x69, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x6c, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x03, 0x52, 0x0c, 0x75, 0x73, 0x65, 0x72, 0x49, 0x6e, 0x74, 0x65, 0x67, 0x72, 0x61, 0x6c,
	...
	0x01, 0x28, 0x09, 0x52, 0x16, 0x69, 0x73, 0x53, 0x75, 0x70, 0x70, 0x6f, 0x72, 0x74, 0x47, 0x6f,
	0x6f, 0x64, 0x73, 0x45, 0x78, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d, 0x64,
	...
	,
	...
	,
...
var file_buyService_proto_msgTypes = make([]protoimpl.MessageInfo, 17)
var file_buyService_proto_goTypes = []interface{}{
	...
	(*IntegralData)(nil),               // 7: services.IntegralData
	(*IntegralDeductionData)(nil),      // 8: services.IntegralDeductionData
	...
	nil,                                // 14: services.BuyConfirmData.ExtensionDataEntry
	nil,                                // 15: services.BuyConfirmData.PluginsDataEntry
	(*IntegralDeductionDataGoods)(nil), // 16: services.IntegralDeductionData.goods
	(*SkuSpecInfo)(nil),                // 17: services.SkuSpecInfo
	(*OrderAddress)(nil),               // 18: services.OrderAddress
	(*OrderExtension)(nil),             // 19: services.OrderExtension
...
var file_buyService_proto_depIdxs = []int32{
	...
	11, // 2: services.BuyGoodsItem.extends:type_name -> services.BuyGoodsItem.ExtendsEntry
	17, // 3: services.BuyGoodsItem.spec:type_name -> services.SkuSpecInfo
	18, // 4: services.OrderBase.address:type_name -> services.OrderAddress
	18, // 5: services.OrderBase.extraction_address:type_name -> services.OrderAddress
	19, // 6: services.OrderBase.extension_data:type_name -> services.OrderExtension
	12, // 7: services.BuyRequest.choice_coupon_ids:type_name -> services.BuyRequest.ChoiceCouponIdsEntry
	4,  // 8: services.BuyRequest.buy_commodity:type_name -> services.BuyCommodity
	4,  // 9: services.BuyRequest.buy_commodities:type_name -> services.BuyCommodity
	17, // 10: services.BuyCommodity.spec:type_name -> services.SkuSpecInfo
	13, // 11: services.DeliveryChoose.buy_header_nav:type_name -> services.DeliveryChoose.item
	13, // 12: services.DeliveryChoose.buy_dropdown_list:type_name -> services.DeliveryChoose.item
	...
	20, // 15: services.BuyConfirmData.payment_list:type_name -> services.PaymentInfo
	3,  // 16: services.BuyConfirmData.request_data:type_name -> services.BuyRequest
	14, // 17: services.BuyConfirmData.extension_data:type_name -> services.BuyConfirmData.ExtensionDataEntry
	15, // 18: services.BuyConfirmData.plugins_data:type_name -> services.BuyConfirmData.PluginsDataEntry
	5,  // 19: services.BuyConfirmData.delivery_choose:type_name -> services.DeliveryChoose
	8,  // 20: services.BuyConfirmData.integral_deduction_data:type_name -> services.IntegralDeductionData
	7,  // 21: services.BuyConfirmData.integral_data:type_name -> services.IntegralData
	16, // 22: services.IntegralDeductionData.deduction_list:type_name -> services.IntegralDeductionData.goods
...
func file_buyService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_buyService_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*IntegralDeductionDataGoods); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
