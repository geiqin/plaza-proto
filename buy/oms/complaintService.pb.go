...
type Complaint struct {
	...
	RefundTime     string                 `protobuf:"bytes,18,opt,name=refund_time,json=refundTime,proto3" json:"refund_time"`             //退款时间
	CancelTime     string                 `protobuf:"bytes,19,opt,name=cancel_time,json=cancelTime,proto3" json:"cancel_time"`             //取消时间
...
func (x *Complaint) GetRefundTime() string {
	if x != nil {
		return x.RefundTime
	}
	return ""
...
func (x *Complaint) GetCancelTime() string {
	if x != nil {
		return x.CancelTime
	}
	return ""
...
var file_complaintService_proto_rawDesc = []byte{
	...
	0x09, 0x52, 0x0a, 0x72, 0x65, 0x66, 0x75, 0x6e, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x1f, 0x0a,
	0x0b, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x18, 0x13, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x0a, 0x63, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x54, 0x69, 0x6d, 0x65, 0x12, 0x16,
