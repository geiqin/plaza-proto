...
var file_cartService_proto_rawDesc = []byte{
	...
	0x03, 0x28, 0x03, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0x5b, 0x0a, 0x0c, 0x43, 0x61, 0x72, 0x74,
	...
	0x65, 0x72, 0x72, 0x6f, 0x72, 0x22, 0x5c, 0x0a, 0x11, 0x43, 0x61, 0x72, 0x74, 0x53, 0x74, 0x6f,
	0x63, 0x6b, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x22, 0x0a, 0x04, 0x64, 0x61,
	0x74, 0x61, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0e, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x72, 0x74, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x12, 0x23,
	...
	0x72, 0x6f, 0x72, 0x32, 0xaa, 0x03, 0x0a, 0x0b, 0x43, 0x61, 0x72, 0x74, 0x53, 0x65, 0x72, 0x76,
	0x69, 0x63, 0x65, 0x12, 0x36, 0x0a, 0x03, 0x41, 0x64, 0x64, 0x12, 0x15, 0x2e, 0x73, 0x65, 0x72,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x38, 0x0a, 0x05, 0x43, 0x6c, 0x65, 0x61, 0x72, 0x12,
	...
	0x12, 0x39, 0x0a, 0x06, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x12, 0x15, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x72, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x16, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x43, 0x61, 0x72,
...
var file_cartService_proto_depIdxs = []int32{
	5,  // 0: services.Cart.spec:type_name -> services.SpecificationData
	6,  // 1: services.CartData.items:type_name -> services.GoodsInfo
	7,  // 2: services.CartData.promotions_data:type_name -> services.PromotionInfo
	5,  // 3: services.CartRequest.spec:type_name -> services.SpecificationData
	1,  // 4: services.CartResponse.data:type_name -> services.CartData
	8,  // 5: services.CartResponse.error:type_name -> common.Error
	0,  // 6: services.CartStockResponse.data:type_name -> services.Cart
	8,  // 7: services.CartStockResponse.error:type_name -> common.Error
	2,  // 8: services.CartService.Add:input_type -> services.CartRequest
	...
	3,  // 15: services.CartService.Add:output_type -> services.CartResponse
	3,  // 16: services.CartService.Remove:output_type -> services.CartResponse
	3,  // 17: services.CartService.Clear:output_type -> services.CartResponse
	3,  // 18: services.CartService.Detail:output_type -> services.CartResponse
	4,  // 19: services.CartService.Stock:output_type -> services.CartStockResponse
	3,  // 20: services.CartService.Count:output_type -> services.CartResponse
	3,  // 21: services.CartService.Checked:output_type -> services.CartResponse
