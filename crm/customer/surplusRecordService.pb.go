...
func (x *SurplusRecord) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *SurplusRecord) GetBalance() float32 {
	if x != nil {
		return x.Balance
	}
	return 0
...
func (x *SurplusRecordRequest) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *SurplusRecordRequest) GetBalance() float32 {
	if x != nil {
		return x.Balance
	}
	return 0
