...
type AddressService interface {
	...
	GetDefault(ctx context.Context, in *Address, opts ...client.CallOption) (*AddressResponse, error)
	Search(ctx context.Context, in *AddressRequest, opts ...client.CallOption) (*AddressResponse, error)
	List(ctx context.Context, in *AddressRequest, opts ...client.CallOption) (*AddressResponse, error)
}
...
func (c *addressService) GetDefault(ctx context.Context, in *Address, opts ...client.CallOption) (*AddressResponse, error) {
...
func (c *addressService) Search(ctx context.Context, in *AddressRequest, opts ...client.CallOption) (*AddressResponse, error) {
...
func (c *addressService) List(ctx context.Context, in *AddressRequest, opts ...client.CallOption) (*AddressResponse, error) {
...
type AddressServiceHandler interface {
	...
	GetDefault(context.Context, *Address, *AddressResponse) error
	Search(context.Context, *AddressRequest, *AddressResponse) error
	List(context.Context, *AddressRequest, *AddressResponse) error
}
...
func RegisterAddressServiceHandler(s server.Server, hdlr AddressServiceHandler, opts ...server.HandlerOption) error {
	type addressService interface {
		...
		GetDefault(ctx context.Context, in *Address, out *AddressResponse) error
		Search(ctx context.Context, in *AddressRequest, out *AddressResponse) error
		List(ctx context.Context, in *AddressRequest, out *AddressResponse) error
	}
	type AddressService struct {
		addressService
	}
...
func (h *addressServiceHandler) GetDefault(ctx context.Context, in *Address, out *AddressResponse) error {
	return h.AddressServiceHandler.GetDefault(ctx, in, out)
}

func (h *addressServiceHandler) Search(ctx context.Context, in *AddressRequest, out *AddressResponse) error {
	return h.AddressServiceHandler.Search(ctx, in, out)
}

func (h *addressServiceHandler) List(ctx context.Context, in *AddressRequest, out *AddressResponse) error {
