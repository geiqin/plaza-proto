...
func (x *InviteData) GetEntity() *Invite {
	if x != nil {
		return x.Entity
	}
	return nil
...
func (x *InviteData) GetPager() *common.Pager {
	if x != nil {
		return x.Pager
	}
	return nil
...
func (x *InviteData) GetItems() []*Invite {
	if x != nil {
		return x.Items
	}
	return nil
...
func (x *InviteData) GetInfo() *common.Info {
	if x != nil {
		return x.Info
	}
	return nil
...
func (x *InviteData) GetParams() map[string]string {
	if x != nil {
		return x.Params
	}
	return nil
...
func (x *InviteResponse) Reset() {
	*x = InviteResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_inviteService_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*InviteResponse) Descriptor() ([]byte, []int) {
	return file_inviteService_proto_rawDescGZIP(), []int{3}
}

func (x *InviteResponse) GetData() *InviteData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_inviteService_proto_rawDesc = []byte{
	...
	0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x04, 0x6d, 0x6f, 0x64, 0x65, 0x22, 0x9a, 0x02, 0x0a, 0x0a,
	0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x12, 0x28, 0x0a, 0x06, 0x65, 0x6e,
	0x74, 0x69, 0x74, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x10, 0x2e, 0x73, 0x65, 0x72,
	0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x06, 0x65, 0x6e,
	...
	0x63, 0x65, 0x73, 0x2e, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x05, 0x69, 0x74, 0x65, 0x6d,
	...
	0x6e, 0x66, 0x6f, 0x12, 0x38, 0x0a, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x05, 0x20,
	0x03, 0x28, 0x0b, 0x32, 0x20, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x49,
	0x6e, 0x76, 0x69, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x2e, 0x50, 0x61, 0x72, 0x61, 0x6d, 0x73,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x22, 0x5f, 0x0a, 0x0e, 0x49, 0x6e, 0x76, 0x69,
	...
	0x63, 0x65, 0x73, 0x2e, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04,
	...
	,
	...
	0x12, 0x3b, 0x0a, 0x04, 0x4c, 0x69, 0x6e, 0x6b, 0x12, 0x17, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69,
	0x63, 0x65, 0x73, 0x2e, 0x49, 0x6e, 0x76, 0x69, 0x74, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x1a, 0x18, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x73, 0x2e, 0x49, 0x6e, 0x76,
	0x69, 0x74, 0x65, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x0d, 0x5a,
...
var file_inviteService_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_inviteService_proto_goTypes = []interface{}{
	(*Invite)(nil),         // 0: services.Invite
	(*InviteRequest)(nil),  // 1: services.InviteRequest
	(*InviteData)(nil),     // 2: services.InviteData
	(*InviteResponse)(nil), // 3: services.InviteResponse
	nil,                    // 4: services.InviteData.ParamsEntry
	(*common.Pager)(nil),   // 5: common.Pager
	(*common.Info)(nil),    // 6: common.Info
	(*common.Error)(nil),   // 7: common.Error
}
var file_inviteService_proto_depIdxs = []int32{
	0,  // 0: services.InviteData.entity:type_name -> services.Invite
	5,  // 1: services.InviteData.pager:type_name -> common.Pager
	0,  // 2: services.InviteData.items:type_name -> services.Invite
	6,  // 3: services.InviteData.info:type_name -> common.Info
	4,  // 4: services.InviteData.params:type_name -> services.InviteData.ParamsEntry
	2,  // 5: services.InviteResponse.data:type_name -> services.InviteData
	7,  // 6: services.InviteResponse.error:type_name -> common.Error
	1,  // 7: services.InviteService.MiniQrcode:input_type -> services.InviteRequest
	1,  // 8: services.InviteService.AppQrcode:input_type -> services.InviteRequest
	1,  // 9: services.InviteService.Link:input_type -> services.InviteRequest
	3,  // 10: services.InviteService.MiniQrcode:output_type -> services.InviteResponse
	3,  // 11: services.InviteService.AppQrcode:output_type -> services.InviteResponse
	3,  // 12: services.InviteService.Link:output_type -> services.InviteResponse
...
func file_inviteService_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_inviteService_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
