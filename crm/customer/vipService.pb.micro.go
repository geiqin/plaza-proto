...
type VipService interface {
	Create(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error)
	Update(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error)
	Delete(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error)
	Get(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error)
	Search(ctx context.Context, in *VipRequest, opts ...client.CallOption) (*VipResponse, error)
...
func (c *vipService) Create(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error) {
...
func (c *vipService) Delete(ctx context.Context, in *Vip, opts ...client.CallOption) (*VipResponse, error) {
...
func (c *vipService) Search(ctx context.Context, in *VipRequest, opts ...client.CallOption) (*VipResponse, error) {
...
type VipServiceHandler interface {
	Create(context.Context, *Vip, *VipResponse) error
	Update(context.Context, *Vip, *VipResponse) error
	Delete(context.Context, *Vip, *VipResponse) error
	Get(context.Context, *Vip, *VipResponse) error
	Search(context.Context, *VipRequest, *VipResponse) error
...
func RegisterVipServiceHandler(s server.Server, hdlr VipServiceHandler, opts ...server.HandlerOption) error {
	type vipService interface {
		Create(ctx context.Context, in *Vip, out *VipResponse) error
		Update(ctx context.Context, in *Vip, out *VipResponse) error
		Delete(ctx context.Context, in *Vip, out *VipResponse) error
		Get(ctx context.Context, in *Vip, out *VipResponse) error
		Search(ctx context.Context, in *VipRequest, out *VipResponse) error
...
func (h *vipServiceHandler) Create(ctx context.Context, in *Vip, out *VipResponse) error {
...
func (h *vipServiceHandler) Delete(ctx context.Context, in *Vip, out *VipResponse) error {
...
func (h *vipServiceHandler) Search(ctx context.Context, in *VipRequest, out *VipResponse) error {
