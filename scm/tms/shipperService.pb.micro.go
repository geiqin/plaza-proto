...
func (c *shipperService) Search(ctx context.Context, in *ShipperRequest, opts ...client.CallOption) (*ShipperResponse, error) {
...
func (h *shipperServiceHandler) Search(ctx context.Context, in *ShipperRequest, out *ShipperResponse) error {
