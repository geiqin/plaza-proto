...
type DeliveryRange struct {
	...
	StartPrice    int64          `protobuf:"varint,4,opt,name=start_price,json=startPrice,proto3" json:"start_price"`
	DeliveryPrice int64          `protobuf:"varint,5,opt,name=delivery_price,json=deliveryPrice,proto3" json:"delivery_price"`
...
func (x *DeliveryRange) GetStartPrice() int64 {
	if x != nil {
		return x.StartPrice
	}
	return 0
...
func (x *DeliveryRange) GetDeliveryPrice() int64 {
	if x != nil {
...
var file_deliveryRangeService_proto_rawDesc = []byte{
	...
	0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x03, 0x52, 0x0a, 0x73, 0x74, 0x61,
	0x72, 0x74, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x25, 0x0a, 0x0e, 0x64, 0x65, 0x6c, 0x69, 0x76,
	0x65, 0x72, 0x79, 0x5f, 0x70, 0x72, 0x69, 0x63, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x03, 0x52,
