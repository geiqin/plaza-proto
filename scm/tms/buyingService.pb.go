...
type Buying struct {
	...
	Dispatch    *DeliveryMethod `protobuf:"bytes,7,opt,name=dispatch,proto3" json:"dispatch"` // 配送信息
}
...
func (x *Buying) GetDispatch() *DeliveryMethod {
	if x != nil {
		return x.Dispatch
	}
	return nil
...
var file_buyingService_proto_rawDesc = []byte{
	...
	0x6d, 0x73, 0x12, 0x34, 0x0a, 0x08, 0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x18, 0x07,
	...
	0x64, 0x69, 0x73, 0x70, 0x61, 0x74, 0x63, 0x68, 0x22, 0xa4, 0x01, 0x0a, 0x0a, 0x42, 0x75, 0x79,
...
var file_buyingService_proto_depIdxs = []int32{
	...
	2,  // 1: services.Buying.dispatch:type_name -> services.DeliveryMethod
