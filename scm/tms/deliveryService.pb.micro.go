...
type DeliveryService interface {
	...
	// 获取同城配送时间
	GetTimes(ctx context.Context, in *DeliveryRequest, opts ...client.CallOption) (*DateListResponse, error)
}
...
func (c *deliveryService) GetTimes(ctx context.Context, in *DeliveryRequest, opts ...client.CallOption) (*DateListResponse, error) {
...
type DeliveryServiceHandler interface {
	...
	// 获取同城配送时间
	GetTimes(context.Context, *DeliveryRequest, *DateListResponse) error
}
...
func RegisterDeliveryServiceHandler(s server.Server, hdlr DeliveryServiceHandler, opts ...server.HandlerOption) error {
	type deliveryService interface {
		...
		GetTimes(ctx context.Context, in *DeliveryRequest, out *DateListResponse) error
	}
	type DeliveryService struct {
		deliveryService
	}
...
func (h *deliveryServiceHandler) GetTimes(ctx context.Context, in *DeliveryRequest, out *DateListResponse) error {
